...
{
    PORTMUX_LUT3_DEFAULT_gv        = 0x00   /* In: PF0, PF1, - Out: - */
} PORTMUX_LUT3_values_t;

/* CCL Look-Up Table 3 Signals select bit group configurations*/
typedef enum PORTMUX_LUT3_enum
{
    PORTMUX_LUT3_DEFAULT_gc        = (PORTMUX_LUT3_DEFAULT_gv << PORTMUX_LUT3_bp)   /* In: PF0, PF1, - Out: - */
} PORTMUX_LUT3_t;
...
typedef enum PORTMUX_TCA0_VALUES_enum
{
    ...
    PORTMUX_TCA0_PORTF_gv          = 0x05   /* WOn: PF0, PF1, -, -, -, - */
...
typedef enum PORTMUX_TCA0_enum
{
    ...
    PORTMUX_TCA0_PORTF_gc          = (PORTMUX_TCA0_PORTF_gv << PORTMUX_TCA0_gp)   /* WOn: PF0, PF1, -, -, -, - */
} PORTMUX_TCA0_t;
...
typedef enum PORTMUX_TCD0_VALUES_enum
{
    ...
    PORTMUX_TCD0_ALT2_gv           = 0x02   /* WOx: PF0, PF1, -, - */
...
typedef enum PORTMUX_TCD0_enum
{
    ...
    PORTMUX_TCD0_ALT2_gc           = (PORTMUX_TCD0_ALT2_gv << PORTMUX_TCD0_gp)   /* WOx: PF0, PF1, -, - */
} PORTMUX_TCD0_t;
...
{
    PORTMUX_USART2_DEFAULT_gv      = 0x00,  /* TxD: PF0, RxD: PF1, XCK: -, XDIR: - */
...
{
    PORTMUX_USART2_DEFAULT_gc      = (PORTMUX_USART2_DEFAULT_gv << PORTMUX_USART2_gp),  /* TxD: PF0, RxD: PF1, XCK: -, XDIR: - */
