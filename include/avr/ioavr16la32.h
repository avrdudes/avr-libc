...
#  define _AVR_IOXXX_H_ "ioavr16la32.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_AVR16LA32_H_INCLUDED
#define _AVR_AVR16LA32_H_INCLUDED
...
{
    PORTMUX_LUT2_DEFAULT_gv        = 0x00,  /* INn: PD0, PD1, PD2. OUT: PD3. */
    PORTMUX_LUT2_ALT1_gv           = 0x01   /* INn: PD0, PD1, PD2. OUT: PD6. */
} PORTMUX_LUT2_values_t;

/* CCL Look-Up Table 2 Signals select bit group configurations*/
typedef enum PORTMUX_LUT2_enum
{
    PORTMUX_LUT2_DEFAULT_gc        = (PORTMUX_LUT2_DEFAULT_gv << PORTMUX_LUT2_bp),  /* INn: PD0, PD1, PD2. OUT: PD3. */
    PORTMUX_LUT2_ALT1_gc           = (PORTMUX_LUT2_ALT1_gv << PORTMUX_LUT2_bp)   /* INn: PD0, PD1, PD2. OUT: PD6. */
} PORTMUX_LUT2_t;
...
{
    PORTMUX_TCE0_PORTA_gv          = 0x00,  /* WOn: PA0, PA1, PA2 */
    PORTMUX_TCE0_PORTC_gv          = 0x02,  /* WOn: PC0, PC1, PC2 */
    PORTMUX_TCE0_PORTD_gv          = 0x03,  /* WOn: PD0, PD1, PD2 */
    PORTMUX_TCE0_PORTF_gv          = 0x05   /* WOn: PF0, PF1, PF2 */
} PORTMUX_TCE0_values_t;

/* TCE0 Signals select bit group configurations*/
typedef enum PORTMUX_TCE0_enum
{
    PORTMUX_TCE0_PORTA_gc          = (PORTMUX_TCE0_PORTA_gv << PORTMUX_TCE0_gp),  /* WOn: PA0, PA1, PA2 */
    PORTMUX_TCE0_PORTC_gc          = (PORTMUX_TCE0_PORTC_gv << PORTMUX_TCE0_gp),  /* WOn: PC0, PC1, PC2 */
    PORTMUX_TCE0_PORTD_gc          = (PORTMUX_TCE0_PORTD_gv << PORTMUX_TCE0_gp),  /* WOn: PD0, PD1, PD2 */
    PORTMUX_TCE0_PORTF_gc          = (PORTMUX_TCE0_PORTF_gv << PORTMUX_TCE0_gp)   /* WOn: PF0, PF1, PF2 */
} PORTMUX_TCE0_t;
...
{
    PORTMUX_USART0_DEFAULT_gv      = 0x00,  /* TxD: PA0, RxD: PA1, AUX0: PA2, AUX1: PA3 */
    PORTMUX_USART0_ALT1_gv         = 0x01,  /* TxD: PA4, RxD: PA5, AUX0: PA6, AUX1: PA7 */
    PORTMUX_USART0_ALT2_gv         = 0x02,  /* TxD: PA2, RxD: PA3, AUX0: -, AUX1: - */
...
{
    PORTMUX_USART0_DEFAULT_gc      = (PORTMUX_USART0_DEFAULT_gv << PORTMUX_USART0_gp),  /* TxD: PA0, RxD: PA1, AUX0: PA2, AUX1: PA3 */
    PORTMUX_USART0_ALT1_gc         = (PORTMUX_USART0_ALT1_gv << PORTMUX_USART0_gp),  /* TxD: PA4, RxD: PA5, AUX0: PA6, AUX1: PA7 */
    PORTMUX_USART0_ALT2_gc         = (PORTMUX_USART0_ALT2_gv << PORTMUX_USART0_gp),  /* TxD: PA2, RxD: PA3, AUX0: -, AUX1: - */
...
#endif /* #ifdef _AVR_AVR16LA32_H_INCLUDED */
