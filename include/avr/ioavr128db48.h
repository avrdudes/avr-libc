...
typedef enum PORTMUX_LUT4_VALUES_enum
{
    ...
    PORTMUX_LUT4_ALT1_gv           = 0x01   /* In: PB0, PB1, PB2 Out: - */
...
typedef enum PORTMUX_LUT4_enum
{
    ...
    PORTMUX_LUT4_ALT1_gc           = (PORTMUX_LUT4_ALT1_gv << PORTMUX_LUT4_bp)   /* In: PB0, PB1, PB2 Out: - */
} PORTMUX_LUT4_t;
...
typedef enum PORTMUX_SPI1_VALUES_enum
{
    ...
    PORTMUX_SPI1_ALT2_gv           = 0x02,  /* MOSI: PB4, MISO: PB5, SCK: -, SS: - */
...
typedef enum PORTMUX_SPI1_enum
{
    ...
    PORTMUX_SPI1_ALT2_gc           = (PORTMUX_SPI1_ALT2_gv << PORTMUX_SPI1_gp),  /* MOSI: PB4, MISO: PB5, SCK: -, SS: - */
...
typedef enum PORTMUX_TCA0_VALUES_enum
{
    ...
    PORTMUX_TCA0_PORTE_gv          = 0x04,  /* WOn: PE0, PE1, PE2, PE3, -, - */
...
typedef enum PORTMUX_TCA0_enum
{
    ...
    PORTMUX_TCA0_PORTE_gc          = (PORTMUX_TCA0_PORTE_gv << PORTMUX_TCA0_gp),  /* WOn: PE0, PE1, PE2, PE3, -, - */
...
typedef enum PORTMUX_TCD0_VALUES_enum
{
    ...
    PORTMUX_TCD0_ALT1_gv           = 0x01,  /* WOx: PB4, PB5, -, - */
...
typedef enum PORTMUX_TCD0_enum
{
    ...
    PORTMUX_TCD0_ALT1_gc           = (PORTMUX_TCD0_ALT1_gv << PORTMUX_TCD0_gp),  /* WOx: PB4, PB5, -, - */
...
typedef enum PORTMUX_TWI1_VALUES_enum
{
    ...
    PORTMUX_TWI1_ALT1_gv           = 0x01,  /* SDA: PF2, SCL: PF3. Dual mode: SDA: -, SCL: -. */
    PORTMUX_TWI1_ALT2_gv           = 0x02   /* SDA: PB2, SCL: PB3. Dual mode: SDA: -, SCL: -. */
...
typedef enum PORTMUX_TWI1_enum
{
    ...
    PORTMUX_TWI1_ALT1_gc           = (PORTMUX_TWI1_ALT1_gv << PORTMUX_TWI1_gp),  /* SDA: PF2, SCL: PF3. Dual mode: SDA: -, SCL: -. */
    PORTMUX_TWI1_ALT2_gc           = (PORTMUX_TWI1_ALT2_gv << PORTMUX_TWI1_gp)   /* SDA: PB2, SCL: PB3. Dual mode: SDA: -, SCL: -. */
} PORTMUX_TWI1_t;
...
typedef enum PORTMUX_USART3_VALUES_enum
{
    ...
    PORTMUX_USART3_ALT1_gv         = 0x01,  /* TxD: PB4, RxD: PB5, XCK: -, XDIR: - */
...
typedef enum PORTMUX_USART3_enum
{
    ...
    PORTMUX_USART3_ALT1_gc         = (PORTMUX_USART3_ALT1_gv << PORTMUX_USART3_gp),  /* TxD: PB4, RxD: PB5, XCK: -, XDIR: - */
