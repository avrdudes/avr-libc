...
typedef enum AC_MUXNEG_VALUES_enum
{
    ...
    AC_MUXNEG_DACREF_gv            = 0x03   /* DAC Reference */
} AC_MUXNEG_values_t;
...
typedef enum ADC_MUXNEG_VALUES_enum
{
    ...
    ADC_MUXNEG_AIN8_gv             = 0x08,  /* ADC input pin 8 */
    ADC_MUXNEG_AIN9_gv             = 0x09,  /* ADC input pin 9 */
    ADC_MUXNEG_AIN10_gv            = 0x0A,  /* ADC input pin 10 */
    ADC_MUXNEG_AIN11_gv            = 0x0B,  /* ADC input pin 11 */
    ADC_MUXNEG_AIN12_gv            = 0x0C,  /* ADC input pin 12 */
    ADC_MUXNEG_AIN13_gv            = 0x0D,  /* ADC input pin 13 */
    ADC_MUXNEG_AIN14_gv            = 0x0E,  /* ADC input pin 14 */
    ADC_MUXNEG_AIN15_gv            = 0x0F,  /* ADC input pin 15 */
...
typedef enum ADC_MUXNEG_enum
{
    ...
    ADC_MUXNEG_AIN8_gc             = (ADC_MUXNEG_AIN8_gv << ADC_MUXNEG_gp),  /* ADC input pin 8 */
    ADC_MUXNEG_AIN9_gc             = (ADC_MUXNEG_AIN9_gv << ADC_MUXNEG_gp),  /* ADC input pin 9 */
    ADC_MUXNEG_AIN10_gc            = (ADC_MUXNEG_AIN10_gv << ADC_MUXNEG_gp),  /* ADC input pin 10 */
    ADC_MUXNEG_AIN11_gc            = (ADC_MUXNEG_AIN11_gv << ADC_MUXNEG_gp),  /* ADC input pin 11 */
    ADC_MUXNEG_AIN12_gc            = (ADC_MUXNEG_AIN12_gv << ADC_MUXNEG_gp),  /* ADC input pin 12 */
    ADC_MUXNEG_AIN13_gc            = (ADC_MUXNEG_AIN13_gv << ADC_MUXNEG_gp),  /* ADC input pin 13 */
    ADC_MUXNEG_AIN14_gc            = (ADC_MUXNEG_AIN14_gv << ADC_MUXNEG_gp),  /* ADC input pin 14 */
    ADC_MUXNEG_AIN15_gc            = (ADC_MUXNEG_AIN15_gv << ADC_MUXNEG_gp),  /* ADC input pin 15 */
...
typedef enum ADC_MUXPOS_VALUES_enum
{
    ...
    ADC_MUXPOS_DACREF0_gv          = 0x49,  /* AC0 DAC Voltage Reference */
    ADC_MUXPOS_DACREF1_gv          = 0x4A,  /* AC1 DAC Voltage Reference */
    ADC_MUXPOS_DACREF2_gv          = 0x4B   /* AC2 DAC Voltage Reference */
} ADC_MUXPOS_values_t;
...
typedef enum ADC_MUXPOS_enum
{
    ...
    ADC_MUXPOS_DACREF0_gc          = (ADC_MUXPOS_DACREF0_gv << ADC_MUXPOS_gp),  /* AC0 DAC Voltage Reference */
    ADC_MUXPOS_DACREF1_gc          = (ADC_MUXPOS_DACREF1_gv << ADC_MUXPOS_gp),  /* AC1 DAC Voltage Reference */
    ADC_MUXPOS_DACREF2_gc          = (ADC_MUXPOS_DACREF2_gv << ADC_MUXPOS_gp)   /* AC2 DAC Voltage Reference */
} ADC_MUXPOS_t;
...
typedef enum CCL_INSEL0_VALUES_enum
{
    ...
    CCL_INSEL0_ZCD0_gv             = 0x07,  /* ZCD0 OUT input source */
    ...
    CCL_INSEL0_TCA1_gv             = 0x0B,  /* TCA1 WO0 input source */
    CCL_INSEL0_TCB0_gv             = 0x0C,  /* TCB0 WO input source */
    CCL_INSEL0_TCD0_gv             = 0x0D   /* TCD0 WOA input source */
} CCL_INSEL0_values_t;
...
typedef enum CCL_INSEL0_enum
{
    ...
    CCL_INSEL0_ZCD0_gc             = (CCL_INSEL0_ZCD0_gv << CCL_INSEL0_gp),  /* ZCD0 OUT input source */
...
typedef enum CCL_INSEL1_VALUES_enum
{
    ...
    CCL_INSEL1_ZCD1_gv             = 0x07,  /* ZCD1 OUT input source */
    ...
    CCL_INSEL1_TCA1_gv             = 0x0B,  /* TCA1 WO1 input source */
    CCL_INSEL1_TCB1_gv             = 0x0C,  /* TCB1 WO input source */
    CCL_INSEL1_TCD0_gv             = 0x0D   /* TCD0 WOB input source */
} CCL_INSEL1_values_t;
...
typedef enum CCL_INSEL1_enum
{
    ...
    CCL_INSEL1_ZCD1_gc             = (CCL_INSEL1_ZCD1_gv << CCL_INSEL1_gp),  /* ZCD1 OUT input source */
...
typedef enum CCL_INSEL2_VALUES_enum
{
    ...
    CCL_INSEL2_ZCD2_gv             = 0x07,  /* ZCD2 OUT input source */
    ...
    CCL_INSEL2_TCA1_gv             = 0x0B,  /* TCA1 WO2 input source */
    CCL_INSEL2_TCB2_gv             = 0x0C,  /* TCB2 WO input source */
    CCL_INSEL2_TCD0_gv             = 0x0D   /* TCD0 WOC input source */
} CCL_INSEL2_values_t;
...
typedef enum CCL_INSEL2_enum
{
    ...
    CCL_INSEL2_ZCD2_gc             = (CCL_INSEL2_ZCD2_gv << CCL_INSEL2_gp),  /* ZCD2 OUT input source */
...
typedef enum EVSYS_CHANNEL0_VALUES_enum
{
    ...
    EVSYS_CHANNEL0_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL0_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL0_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL0_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL0_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL0_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL0_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL0_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL0_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL0_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL0_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL0_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL0_PORTB_PIN0_gv   = 0x48,  /* Port B Pin 0 */
    EVSYS_CHANNEL0_PORTB_PIN1_gv   = 0x49,  /* Port B Pin 1 */
    EVSYS_CHANNEL0_PORTB_PIN2_gv   = 0x4A,  /* Port B Pin 2 */
    EVSYS_CHANNEL0_PORTB_PIN3_gv   = 0x4B,  /* Port B Pin 3 */
    EVSYS_CHANNEL0_PORTB_PIN4_gv   = 0x4C,  /* Port B Pin 4 */
    EVSYS_CHANNEL0_PORTB_PIN5_gv   = 0x4D,  /* Port B Pin 5 */
    EVSYS_CHANNEL0_PORTB_PIN6_gv   = 0x4E,  /* Port B Pin 6 */
    EVSYS_CHANNEL0_PORTB_PIN7_gv   = 0x4F,  /* Port B Pin 7 */
    EVSYS_CHANNEL0_USART0_XCK_gv   = 0x60,  /* USART 0 XCK */
    EVSYS_CHANNEL0_USART1_XCK_gv   = 0x61,  /* USART 1 XCK */
    EVSYS_CHANNEL0_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL0_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL0_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL0_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL0_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL0_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL0_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL0_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL0_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL0_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL0_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL0_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL0_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL0_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL0_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL0_enum
{
    ...
    EVSYS_CHANNEL0_CCL_LUT4_gc     = (EVSYS_CHANNEL0_CCL_LUT4_gv << EVSYS_CHANNEL0_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL0_CCL_LUT5_gc     = (EVSYS_CHANNEL0_CCL_LUT5_gv << EVSYS_CHANNEL0_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL0_AC0_OUT_gc      = (EVSYS_CHANNEL0_AC0_OUT_gv << EVSYS_CHANNEL0_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL0_AC1_OUT_gc      = (EVSYS_CHANNEL0_AC1_OUT_gv << EVSYS_CHANNEL0_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL0_AC2_OUT_gc      = (EVSYS_CHANNEL0_AC2_OUT_gv << EVSYS_CHANNEL0_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL0_ADC0_RESRDY_gc  = (EVSYS_CHANNEL0_ADC0_RESRDY_gv << EVSYS_CHANNEL0_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL0_ZCD0_gc         = (EVSYS_CHANNEL0_ZCD0_gv << EVSYS_CHANNEL0_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL0_ZCD1_gc         = (EVSYS_CHANNEL0_ZCD1_gv << EVSYS_CHANNEL0_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL0_ZCD2_gc         = (EVSYS_CHANNEL0_ZCD2_gv << EVSYS_CHANNEL0_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL0_OPAMP0_READY_gc = (EVSYS_CHANNEL0_OPAMP0_READY_gv << EVSYS_CHANNEL0_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL0_OPAMP1_READY_gc = (EVSYS_CHANNEL0_OPAMP1_READY_gv << EVSYS_CHANNEL0_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL0_OPAMP2_READY_gc = (EVSYS_CHANNEL0_OPAMP2_READY_gv << EVSYS_CHANNEL0_gp),  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL0_PORTB_PIN0_gc   = (EVSYS_CHANNEL0_PORTB_PIN0_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 0 */
    EVSYS_CHANNEL0_PORTB_PIN1_gc   = (EVSYS_CHANNEL0_PORTB_PIN1_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 1 */
    EVSYS_CHANNEL0_PORTB_PIN2_gc   = (EVSYS_CHANNEL0_PORTB_PIN2_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 2 */
    EVSYS_CHANNEL0_PORTB_PIN3_gc   = (EVSYS_CHANNEL0_PORTB_PIN3_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 3 */
    EVSYS_CHANNEL0_PORTB_PIN4_gc   = (EVSYS_CHANNEL0_PORTB_PIN4_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 4 */
    EVSYS_CHANNEL0_PORTB_PIN5_gc   = (EVSYS_CHANNEL0_PORTB_PIN5_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 5 */
    EVSYS_CHANNEL0_PORTB_PIN6_gc   = (EVSYS_CHANNEL0_PORTB_PIN6_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 6 */
    EVSYS_CHANNEL0_PORTB_PIN7_gc   = (EVSYS_CHANNEL0_PORTB_PIN7_gv << EVSYS_CHANNEL0_gp),  /* Port B Pin 7 */
    ...
    EVSYS_CHANNEL0_USART2_XCK_gc   = (EVSYS_CHANNEL0_USART2_XCK_gv << EVSYS_CHANNEL0_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL0_USART3_XCK_gc   = (EVSYS_CHANNEL0_USART3_XCK_gv << EVSYS_CHANNEL0_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL0_USART4_XCK_gc   = (EVSYS_CHANNEL0_USART4_XCK_gv << EVSYS_CHANNEL0_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL0_USART5_XCK_gc   = (EVSYS_CHANNEL0_USART5_XCK_gv << EVSYS_CHANNEL0_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL0_SPI0_SCK_gc     = (EVSYS_CHANNEL0_SPI0_SCK_gv << EVSYS_CHANNEL0_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL0_SPI1_SCK_gc     = (EVSYS_CHANNEL0_SPI1_SCK_gv << EVSYS_CHANNEL0_gp),  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL0_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL0_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL0_TCA1_HUNF_gc    = (EVSYS_CHANNEL0_TCA1_HUNF_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL0_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL0_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL0_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL0_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL0_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL0_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL0_TCB3_CAPT_gc    = (EVSYS_CHANNEL0_TCB3_CAPT_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL0_TCB3_OVF_gc     = (EVSYS_CHANNEL0_TCB3_OVF_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL0_TCB4_CAPT_gc    = (EVSYS_CHANNEL0_TCB4_CAPT_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL0_TCB4_OVF_gc     = (EVSYS_CHANNEL0_TCB4_OVF_gv << EVSYS_CHANNEL0_gp),  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL1_VALUES_enum
{
    ...
    EVSYS_CHANNEL1_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL1_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL1_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL1_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL1_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL1_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL1_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL1_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL1_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL1_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL1_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL1_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL1_PORTB_PIN0_gv   = 0x48,  /* Port B Pin 0 */
    EVSYS_CHANNEL1_PORTB_PIN1_gv   = 0x49,  /* Port B Pin 1 */
    EVSYS_CHANNEL1_PORTB_PIN2_gv   = 0x4A,  /* Port B Pin 2 */
    EVSYS_CHANNEL1_PORTB_PIN3_gv   = 0x4B,  /* Port B Pin 3 */
    EVSYS_CHANNEL1_PORTB_PIN4_gv   = 0x4C,  /* Port B Pin 4 */
    EVSYS_CHANNEL1_PORTB_PIN5_gv   = 0x4D,  /* Port B Pin 5 */
    EVSYS_CHANNEL1_PORTB_PIN6_gv   = 0x4E,  /* Port B Pin 6 */
    EVSYS_CHANNEL1_PORTB_PIN7_gv   = 0x4F,  /* Port B Pin 7 */
    EVSYS_CHANNEL1_USART0_XCK_gv   = 0x60,  /* USART 0 XCK */
    EVSYS_CHANNEL1_USART1_XCK_gv   = 0x61,  /* USART 1 XCK */
    EVSYS_CHANNEL1_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL1_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL1_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL1_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL1_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL1_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL1_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL1_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL1_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL1_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL1_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL1_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL1_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL1_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL1_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL1_enum
{
    ...
    EVSYS_CHANNEL1_CCL_LUT4_gc     = (EVSYS_CHANNEL1_CCL_LUT4_gv << EVSYS_CHANNEL1_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL1_CCL_LUT5_gc     = (EVSYS_CHANNEL1_CCL_LUT5_gv << EVSYS_CHANNEL1_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL1_AC0_OUT_gc      = (EVSYS_CHANNEL1_AC0_OUT_gv << EVSYS_CHANNEL1_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL1_AC1_OUT_gc      = (EVSYS_CHANNEL1_AC1_OUT_gv << EVSYS_CHANNEL1_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL1_AC2_OUT_gc      = (EVSYS_CHANNEL1_AC2_OUT_gv << EVSYS_CHANNEL1_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL1_ADC0_RESRDY_gc  = (EVSYS_CHANNEL1_ADC0_RESRDY_gv << EVSYS_CHANNEL1_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL1_ZCD0_gc         = (EVSYS_CHANNEL1_ZCD0_gv << EVSYS_CHANNEL1_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL1_ZCD1_gc         = (EVSYS_CHANNEL1_ZCD1_gv << EVSYS_CHANNEL1_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL1_ZCD2_gc         = (EVSYS_CHANNEL1_ZCD2_gv << EVSYS_CHANNEL1_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL1_OPAMP0_READY_gc = (EVSYS_CHANNEL1_OPAMP0_READY_gv << EVSYS_CHANNEL1_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL1_OPAMP1_READY_gc = (EVSYS_CHANNEL1_OPAMP1_READY_gv << EVSYS_CHANNEL1_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL1_OPAMP2_READY_gc = (EVSYS_CHANNEL1_OPAMP2_READY_gv << EVSYS_CHANNEL1_gp),  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL1_PORTB_PIN0_gc   = (EVSYS_CHANNEL1_PORTB_PIN0_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 0 */
    EVSYS_CHANNEL1_PORTB_PIN1_gc   = (EVSYS_CHANNEL1_PORTB_PIN1_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 1 */
    EVSYS_CHANNEL1_PORTB_PIN2_gc   = (EVSYS_CHANNEL1_PORTB_PIN2_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 2 */
    EVSYS_CHANNEL1_PORTB_PIN3_gc   = (EVSYS_CHANNEL1_PORTB_PIN3_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 3 */
    EVSYS_CHANNEL1_PORTB_PIN4_gc   = (EVSYS_CHANNEL1_PORTB_PIN4_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 4 */
    EVSYS_CHANNEL1_PORTB_PIN5_gc   = (EVSYS_CHANNEL1_PORTB_PIN5_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 5 */
    EVSYS_CHANNEL1_PORTB_PIN6_gc   = (EVSYS_CHANNEL1_PORTB_PIN6_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 6 */
    EVSYS_CHANNEL1_PORTB_PIN7_gc   = (EVSYS_CHANNEL1_PORTB_PIN7_gv << EVSYS_CHANNEL1_gp),  /* Port B Pin 7 */
    ...
    EVSYS_CHANNEL1_USART2_XCK_gc   = (EVSYS_CHANNEL1_USART2_XCK_gv << EVSYS_CHANNEL1_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL1_USART3_XCK_gc   = (EVSYS_CHANNEL1_USART3_XCK_gv << EVSYS_CHANNEL1_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL1_USART4_XCK_gc   = (EVSYS_CHANNEL1_USART4_XCK_gv << EVSYS_CHANNEL1_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL1_USART5_XCK_gc   = (EVSYS_CHANNEL1_USART5_XCK_gv << EVSYS_CHANNEL1_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL1_SPI0_SCK_gc     = (EVSYS_CHANNEL1_SPI0_SCK_gv << EVSYS_CHANNEL1_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL1_SPI1_SCK_gc     = (EVSYS_CHANNEL1_SPI1_SCK_gv << EVSYS_CHANNEL1_gp),  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL1_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL1_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL1_TCA1_HUNF_gc    = (EVSYS_CHANNEL1_TCA1_HUNF_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL1_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL1_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL1_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL1_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL1_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL1_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL1_TCB3_CAPT_gc    = (EVSYS_CHANNEL1_TCB3_CAPT_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL1_TCB3_OVF_gc     = (EVSYS_CHANNEL1_TCB3_OVF_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL1_TCB4_CAPT_gc    = (EVSYS_CHANNEL1_TCB4_CAPT_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL1_TCB4_OVF_gc     = (EVSYS_CHANNEL1_TCB4_OVF_gv << EVSYS_CHANNEL1_gp),  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL2_VALUES_enum
{
    ...
    EVSYS_CHANNEL2_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL2_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL2_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL2_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL2_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL2_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL2_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL2_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL2_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL2_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL2_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL2_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL2_PORTC_PIN4_gv   = 0x44,  /* Port C Pin 4 */
    EVSYS_CHANNEL2_PORTC_PIN5_gv   = 0x45,  /* Port C Pin 5 */
    EVSYS_CHANNEL2_PORTC_PIN6_gv   = 0x46,  /* Port C Pin 6 */
    EVSYS_CHANNEL2_PORTC_PIN7_gv   = 0x47,  /* Port C Pin 7 */
    EVSYS_CHANNEL2_PORTD_PIN0_gv   = 0x48,  /* Port D Pin 0 */
    ...
    EVSYS_CHANNEL2_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL2_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL2_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL2_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL2_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL2_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL2_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL2_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL2_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL2_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL2_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL2_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL2_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL2_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL2_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL2_enum
{
    ...
    EVSYS_CHANNEL2_CCL_LUT4_gc     = (EVSYS_CHANNEL2_CCL_LUT4_gv << EVSYS_CHANNEL2_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL2_CCL_LUT5_gc     = (EVSYS_CHANNEL2_CCL_LUT5_gv << EVSYS_CHANNEL2_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL2_AC0_OUT_gc      = (EVSYS_CHANNEL2_AC0_OUT_gv << EVSYS_CHANNEL2_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL2_AC1_OUT_gc      = (EVSYS_CHANNEL2_AC1_OUT_gv << EVSYS_CHANNEL2_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL2_AC2_OUT_gc      = (EVSYS_CHANNEL2_AC2_OUT_gv << EVSYS_CHANNEL2_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL2_ADC0_RESRDY_gc  = (EVSYS_CHANNEL2_ADC0_RESRDY_gv << EVSYS_CHANNEL2_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL2_ZCD0_gc         = (EVSYS_CHANNEL2_ZCD0_gv << EVSYS_CHANNEL2_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL2_ZCD1_gc         = (EVSYS_CHANNEL2_ZCD1_gv << EVSYS_CHANNEL2_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL2_ZCD2_gc         = (EVSYS_CHANNEL2_ZCD2_gv << EVSYS_CHANNEL2_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL2_OPAMP0_READY_gc = (EVSYS_CHANNEL2_OPAMP0_READY_gv << EVSYS_CHANNEL2_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL2_OPAMP1_READY_gc = (EVSYS_CHANNEL2_OPAMP1_READY_gv << EVSYS_CHANNEL2_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL2_OPAMP2_READY_gc = (EVSYS_CHANNEL2_OPAMP2_READY_gv << EVSYS_CHANNEL2_gp),  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL2_PORTC_PIN4_gc   = (EVSYS_CHANNEL2_PORTC_PIN4_gv << EVSYS_CHANNEL2_gp),  /* Port C Pin 4 */
    EVSYS_CHANNEL2_PORTC_PIN5_gc   = (EVSYS_CHANNEL2_PORTC_PIN5_gv << EVSYS_CHANNEL2_gp),  /* Port C Pin 5 */
    EVSYS_CHANNEL2_PORTC_PIN6_gc   = (EVSYS_CHANNEL2_PORTC_PIN6_gv << EVSYS_CHANNEL2_gp),  /* Port C Pin 6 */
    EVSYS_CHANNEL2_PORTC_PIN7_gc   = (EVSYS_CHANNEL2_PORTC_PIN7_gv << EVSYS_CHANNEL2_gp),  /* Port C Pin 7 */
    EVSYS_CHANNEL2_PORTD_PIN0_gc   = (EVSYS_CHANNEL2_PORTD_PIN0_gv << EVSYS_CHANNEL2_gp),  /* Port D Pin 0 */
    ...
    EVSYS_CHANNEL2_USART2_XCK_gc   = (EVSYS_CHANNEL2_USART2_XCK_gv << EVSYS_CHANNEL2_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL2_USART3_XCK_gc   = (EVSYS_CHANNEL2_USART3_XCK_gv << EVSYS_CHANNEL2_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL2_USART4_XCK_gc   = (EVSYS_CHANNEL2_USART4_XCK_gv << EVSYS_CHANNEL2_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL2_USART5_XCK_gc   = (EVSYS_CHANNEL2_USART5_XCK_gv << EVSYS_CHANNEL2_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL2_SPI0_SCK_gc     = (EVSYS_CHANNEL2_SPI0_SCK_gv << EVSYS_CHANNEL2_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL2_SPI1_SCK_gc     = (EVSYS_CHANNEL2_SPI1_SCK_gv << EVSYS_CHANNEL2_gp),  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL2_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL2_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL2_TCA1_HUNF_gc    = (EVSYS_CHANNEL2_TCA1_HUNF_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL2_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL2_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL2_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL2_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL2_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL2_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL2_TCB3_CAPT_gc    = (EVSYS_CHANNEL2_TCB3_CAPT_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL2_TCB3_OVF_gc     = (EVSYS_CHANNEL2_TCB3_OVF_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL2_TCB4_CAPT_gc    = (EVSYS_CHANNEL2_TCB4_CAPT_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL2_TCB4_OVF_gc     = (EVSYS_CHANNEL2_TCB4_OVF_gv << EVSYS_CHANNEL2_gp),  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL3_VALUES_enum
{
    ...
    EVSYS_CHANNEL3_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL3_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL3_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL3_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL3_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL3_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL3_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL3_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL3_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL3_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL3_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL3_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL3_PORTC_PIN4_gv   = 0x44,  /* Port C Pin 4 */
    EVSYS_CHANNEL3_PORTC_PIN5_gv   = 0x45,  /* Port C Pin 5 */
    EVSYS_CHANNEL3_PORTC_PIN6_gv   = 0x46,  /* Port C Pin 6 */
    EVSYS_CHANNEL3_PORTC_PIN7_gv   = 0x47,  /* Port C Pin 7 */
    EVSYS_CHANNEL3_PORTD_PIN0_gv   = 0x48,  /* Port D Pin 0 */
    ...
    EVSYS_CHANNEL3_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL3_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL3_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL3_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL3_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL3_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL3_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL3_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL3_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL3_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL3_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL3_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL3_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL3_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL3_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL3_enum
{
    ...
    EVSYS_CHANNEL3_CCL_LUT4_gc     = (EVSYS_CHANNEL3_CCL_LUT4_gv << EVSYS_CHANNEL3_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL3_CCL_LUT5_gc     = (EVSYS_CHANNEL3_CCL_LUT5_gv << EVSYS_CHANNEL3_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL3_AC0_OUT_gc      = (EVSYS_CHANNEL3_AC0_OUT_gv << EVSYS_CHANNEL3_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL3_AC1_OUT_gc      = (EVSYS_CHANNEL3_AC1_OUT_gv << EVSYS_CHANNEL3_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL3_AC2_OUT_gc      = (EVSYS_CHANNEL3_AC2_OUT_gv << EVSYS_CHANNEL3_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL3_ADC0_RESRDY_gc  = (EVSYS_CHANNEL3_ADC0_RESRDY_gv << EVSYS_CHANNEL3_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL3_ZCD0_gc         = (EVSYS_CHANNEL3_ZCD0_gv << EVSYS_CHANNEL3_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL3_ZCD1_gc         = (EVSYS_CHANNEL3_ZCD1_gv << EVSYS_CHANNEL3_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL3_ZCD2_gc         = (EVSYS_CHANNEL3_ZCD2_gv << EVSYS_CHANNEL3_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL3_OPAMP0_READY_gc = (EVSYS_CHANNEL3_OPAMP0_READY_gv << EVSYS_CHANNEL3_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL3_OPAMP1_READY_gc = (EVSYS_CHANNEL3_OPAMP1_READY_gv << EVSYS_CHANNEL3_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL3_OPAMP2_READY_gc = (EVSYS_CHANNEL3_OPAMP2_READY_gv << EVSYS_CHANNEL3_gp),  /* OPAMP2 Ready */
    ...
    EVSYS_CHANNEL3_PORTC_PIN4_gc   = (EVSYS_CHANNEL3_PORTC_PIN4_gv << EVSYS_CHANNEL3_gp),  /* Port C Pin 4 */
    EVSYS_CHANNEL3_PORTC_PIN5_gc   = (EVSYS_CHANNEL3_PORTC_PIN5_gv << EVSYS_CHANNEL3_gp),  /* Port C Pin 5 */
    EVSYS_CHANNEL3_PORTC_PIN6_gc   = (EVSYS_CHANNEL3_PORTC_PIN6_gv << EVSYS_CHANNEL3_gp),  /* Port C Pin 6 */
    EVSYS_CHANNEL3_PORTC_PIN7_gc   = (EVSYS_CHANNEL3_PORTC_PIN7_gv << EVSYS_CHANNEL3_gp),  /* Port C Pin 7 */
    EVSYS_CHANNEL3_PORTD_PIN0_gc   = (EVSYS_CHANNEL3_PORTD_PIN0_gv << EVSYS_CHANNEL3_gp),  /* Port D Pin 0 */
    ...
    EVSYS_CHANNEL3_USART2_XCK_gc   = (EVSYS_CHANNEL3_USART2_XCK_gv << EVSYS_CHANNEL3_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL3_USART3_XCK_gc   = (EVSYS_CHANNEL3_USART3_XCK_gv << EVSYS_CHANNEL3_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL3_USART4_XCK_gc   = (EVSYS_CHANNEL3_USART4_XCK_gv << EVSYS_CHANNEL3_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL3_USART5_XCK_gc   = (EVSYS_CHANNEL3_USART5_XCK_gv << EVSYS_CHANNEL3_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL3_SPI0_SCK_gc     = (EVSYS_CHANNEL3_SPI0_SCK_gv << EVSYS_CHANNEL3_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL3_SPI1_SCK_gc     = (EVSYS_CHANNEL3_SPI1_SCK_gv << EVSYS_CHANNEL3_gp),  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL3_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL3_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL3_TCA1_HUNF_gc    = (EVSYS_CHANNEL3_TCA1_HUNF_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL3_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL3_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL3_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL3_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL3_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL3_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL3_TCB3_CAPT_gc    = (EVSYS_CHANNEL3_TCB3_CAPT_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL3_TCB3_OVF_gc     = (EVSYS_CHANNEL3_TCB3_OVF_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL3_TCB4_CAPT_gc    = (EVSYS_CHANNEL3_TCB4_CAPT_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL3_TCB4_OVF_gc     = (EVSYS_CHANNEL3_TCB4_OVF_gv << EVSYS_CHANNEL3_gp),  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL4_VALUES_enum
{
    ...
    EVSYS_CHANNEL4_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL4_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL4_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL4_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL4_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL4_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL4_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL4_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL4_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL4_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL4_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL4_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    EVSYS_CHANNEL4_PORTE_PIN0_gv   = 0x40,  /* Port E Pin 0 */
    EVSYS_CHANNEL4_PORTE_PIN1_gv   = 0x41,  /* Port E Pin 1 */
    EVSYS_CHANNEL4_PORTE_PIN2_gv   = 0x42,  /* Port E Pin 2 */
    EVSYS_CHANNEL4_PORTE_PIN3_gv   = 0x43,  /* Port E Pin 3 */
    EVSYS_CHANNEL4_PORTE_PIN4_gv   = 0x44,  /* Port E Pin 4 */
    EVSYS_CHANNEL4_PORTE_PIN5_gv   = 0x45,  /* Port E Pin 5 */
    EVSYS_CHANNEL4_PORTE_PIN6_gv   = 0x46,  /* Port E Pin 6 */
    EVSYS_CHANNEL4_PORTE_PIN7_gv   = 0x47,  /* Port E Pin 7 */
    ...
    EVSYS_CHANNEL4_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL4_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL4_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL4_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL4_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL4_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL4_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL4_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL4_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL4_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL4_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL4_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL4_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL4_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL4_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL4_enum
{
    ...
    EVSYS_CHANNEL4_CCL_LUT4_gc     = (EVSYS_CHANNEL4_CCL_LUT4_gv << EVSYS_CHANNEL4_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL4_CCL_LUT5_gc     = (EVSYS_CHANNEL4_CCL_LUT5_gv << EVSYS_CHANNEL4_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL4_AC0_OUT_gc      = (EVSYS_CHANNEL4_AC0_OUT_gv << EVSYS_CHANNEL4_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL4_AC1_OUT_gc      = (EVSYS_CHANNEL4_AC1_OUT_gv << EVSYS_CHANNEL4_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL4_AC2_OUT_gc      = (EVSYS_CHANNEL4_AC2_OUT_gv << EVSYS_CHANNEL4_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL4_ADC0_RESRDY_gc  = (EVSYS_CHANNEL4_ADC0_RESRDY_gv << EVSYS_CHANNEL4_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL4_ZCD0_gc         = (EVSYS_CHANNEL4_ZCD0_gv << EVSYS_CHANNEL4_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL4_ZCD1_gc         = (EVSYS_CHANNEL4_ZCD1_gv << EVSYS_CHANNEL4_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL4_ZCD2_gc         = (EVSYS_CHANNEL4_ZCD2_gv << EVSYS_CHANNEL4_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL4_OPAMP0_READY_gc = (EVSYS_CHANNEL4_OPAMP0_READY_gv << EVSYS_CHANNEL4_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL4_OPAMP1_READY_gc = (EVSYS_CHANNEL4_OPAMP1_READY_gv << EVSYS_CHANNEL4_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL4_OPAMP2_READY_gc = (EVSYS_CHANNEL4_OPAMP2_READY_gv << EVSYS_CHANNEL4_gp),  /* OPAMP2 Ready */
    EVSYS_CHANNEL4_PORTE_PIN0_gc   = (EVSYS_CHANNEL4_PORTE_PIN0_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 0 */
    EVSYS_CHANNEL4_PORTE_PIN1_gc   = (EVSYS_CHANNEL4_PORTE_PIN1_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 1 */
    EVSYS_CHANNEL4_PORTE_PIN2_gc   = (EVSYS_CHANNEL4_PORTE_PIN2_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 2 */
    EVSYS_CHANNEL4_PORTE_PIN3_gc   = (EVSYS_CHANNEL4_PORTE_PIN3_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 3 */
    EVSYS_CHANNEL4_PORTE_PIN4_gc   = (EVSYS_CHANNEL4_PORTE_PIN4_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 4 */
    EVSYS_CHANNEL4_PORTE_PIN5_gc   = (EVSYS_CHANNEL4_PORTE_PIN5_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 5 */
    EVSYS_CHANNEL4_PORTE_PIN6_gc   = (EVSYS_CHANNEL4_PORTE_PIN6_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 6 */
    EVSYS_CHANNEL4_PORTE_PIN7_gc   = (EVSYS_CHANNEL4_PORTE_PIN7_gv << EVSYS_CHANNEL4_gp),  /* Port E Pin 7 */
    ...
    EVSYS_CHANNEL4_USART2_XCK_gc   = (EVSYS_CHANNEL4_USART2_XCK_gv << EVSYS_CHANNEL4_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL4_USART3_XCK_gc   = (EVSYS_CHANNEL4_USART3_XCK_gv << EVSYS_CHANNEL4_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL4_USART4_XCK_gc   = (EVSYS_CHANNEL4_USART4_XCK_gv << EVSYS_CHANNEL4_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL4_USART5_XCK_gc   = (EVSYS_CHANNEL4_USART5_XCK_gv << EVSYS_CHANNEL4_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL4_SPI0_SCK_gc     = (EVSYS_CHANNEL4_SPI0_SCK_gv << EVSYS_CHANNEL4_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL4_SPI1_SCK_gc     = (EVSYS_CHANNEL4_SPI1_SCK_gv << EVSYS_CHANNEL4_gp),  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL4_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL4_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL4_TCA1_HUNF_gc    = (EVSYS_CHANNEL4_TCA1_HUNF_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL4_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL4_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL4_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL4_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL4_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL4_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL4_TCB3_CAPT_gc    = (EVSYS_CHANNEL4_TCB3_CAPT_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL4_TCB3_OVF_gc     = (EVSYS_CHANNEL4_TCB3_OVF_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL4_TCB4_CAPT_gc    = (EVSYS_CHANNEL4_TCB4_CAPT_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL4_TCB4_OVF_gc     = (EVSYS_CHANNEL4_TCB4_OVF_gv << EVSYS_CHANNEL4_gp),  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL5_VALUES_enum
{
    ...
    EVSYS_CHANNEL5_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL5_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL5_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL5_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL5_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL5_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL5_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL5_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL5_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL5_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL5_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL5_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    EVSYS_CHANNEL5_PORTE_PIN0_gv   = 0x40,  /* Port E Pin 0 */
    EVSYS_CHANNEL5_PORTE_PIN1_gv   = 0x41,  /* Port E Pin 1 */
    EVSYS_CHANNEL5_PORTE_PIN2_gv   = 0x42,  /* Port E Pin 2 */
    EVSYS_CHANNEL5_PORTE_PIN3_gv   = 0x43,  /* Port E Pin 3 */
    EVSYS_CHANNEL5_PORTE_PIN4_gv   = 0x44,  /* Port E Pin 4 */
    EVSYS_CHANNEL5_PORTE_PIN5_gv   = 0x45,  /* Port E Pin 5 */
    EVSYS_CHANNEL5_PORTE_PIN6_gv   = 0x46,  /* Port E Pin 6 */
    EVSYS_CHANNEL5_PORTE_PIN7_gv   = 0x47,  /* Port E Pin 7 */
    ...
    EVSYS_CHANNEL5_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL5_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL5_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL5_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL5_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL5_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL5_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL5_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL5_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL5_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL5_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL5_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL5_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL5_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL5_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
...
typedef enum EVSYS_CHANNEL5_enum
{
    ...
    EVSYS_CHANNEL5_CCL_LUT4_gc     = (EVSYS_CHANNEL5_CCL_LUT4_gv << EVSYS_CHANNEL5_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL5_CCL_LUT5_gc     = (EVSYS_CHANNEL5_CCL_LUT5_gv << EVSYS_CHANNEL5_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL5_AC0_OUT_gc      = (EVSYS_CHANNEL5_AC0_OUT_gv << EVSYS_CHANNEL5_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL5_AC1_OUT_gc      = (EVSYS_CHANNEL5_AC1_OUT_gv << EVSYS_CHANNEL5_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL5_AC2_OUT_gc      = (EVSYS_CHANNEL5_AC2_OUT_gv << EVSYS_CHANNEL5_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL5_ADC0_RESRDY_gc  = (EVSYS_CHANNEL5_ADC0_RESRDY_gv << EVSYS_CHANNEL5_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL5_ZCD0_gc         = (EVSYS_CHANNEL5_ZCD0_gv << EVSYS_CHANNEL5_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL5_ZCD1_gc         = (EVSYS_CHANNEL5_ZCD1_gv << EVSYS_CHANNEL5_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL5_ZCD2_gc         = (EVSYS_CHANNEL5_ZCD2_gv << EVSYS_CHANNEL5_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL5_OPAMP0_READY_gc = (EVSYS_CHANNEL5_OPAMP0_READY_gv << EVSYS_CHANNEL5_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL5_OPAMP1_READY_gc = (EVSYS_CHANNEL5_OPAMP1_READY_gv << EVSYS_CHANNEL5_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL5_OPAMP2_READY_gc = (EVSYS_CHANNEL5_OPAMP2_READY_gv << EVSYS_CHANNEL5_gp),  /* OPAMP2 Ready */
    EVSYS_CHANNEL5_PORTE_PIN0_gc   = (EVSYS_CHANNEL5_PORTE_PIN0_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 0 */
    EVSYS_CHANNEL5_PORTE_PIN1_gc   = (EVSYS_CHANNEL5_PORTE_PIN1_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 1 */
    EVSYS_CHANNEL5_PORTE_PIN2_gc   = (EVSYS_CHANNEL5_PORTE_PIN2_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 2 */
    EVSYS_CHANNEL5_PORTE_PIN3_gc   = (EVSYS_CHANNEL5_PORTE_PIN3_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 3 */
    EVSYS_CHANNEL5_PORTE_PIN4_gc   = (EVSYS_CHANNEL5_PORTE_PIN4_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 4 */
    EVSYS_CHANNEL5_PORTE_PIN5_gc   = (EVSYS_CHANNEL5_PORTE_PIN5_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 5 */
    EVSYS_CHANNEL5_PORTE_PIN6_gc   = (EVSYS_CHANNEL5_PORTE_PIN6_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 6 */
    EVSYS_CHANNEL5_PORTE_PIN7_gc   = (EVSYS_CHANNEL5_PORTE_PIN7_gv << EVSYS_CHANNEL5_gp),  /* Port E Pin 7 */
    ...
    EVSYS_CHANNEL5_USART2_XCK_gc   = (EVSYS_CHANNEL5_USART2_XCK_gv << EVSYS_CHANNEL5_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL5_USART3_XCK_gc   = (EVSYS_CHANNEL5_USART3_XCK_gv << EVSYS_CHANNEL5_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL5_USART4_XCK_gc   = (EVSYS_CHANNEL5_USART4_XCK_gv << EVSYS_CHANNEL5_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL5_USART5_XCK_gc   = (EVSYS_CHANNEL5_USART5_XCK_gv << EVSYS_CHANNEL5_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL5_SPI0_SCK_gc     = (EVSYS_CHANNEL5_SPI0_SCK_gv << EVSYS_CHANNEL5_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL5_SPI1_SCK_gc     = (EVSYS_CHANNEL5_SPI1_SCK_gv << EVSYS_CHANNEL5_gp),  /* SPI 1 SCK */
    ...
    EVSYS_CHANNEL5_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL5_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL5_TCA1_HUNF_gc    = (EVSYS_CHANNEL5_TCA1_HUNF_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL5_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL5_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL5_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL5_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL5_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL5_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    ...
    EVSYS_CHANNEL5_TCB3_CAPT_gc    = (EVSYS_CHANNEL5_TCB3_CAPT_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL5_TCB3_OVF_gc     = (EVSYS_CHANNEL5_TCB3_OVF_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL5_TCB4_CAPT_gc    = (EVSYS_CHANNEL5_TCB4_CAPT_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL5_TCB4_OVF_gc     = (EVSYS_CHANNEL5_TCB4_OVF_gv << EVSYS_CHANNEL5_gp),  /* Timer/Counter B4 overflow */
...
/* Channel 6 generator select bit group values */
typedef enum EVSYS_CHANNEL6_VALUES_enum
{
    EVSYS_CHANNEL6_OFF_gv          = 0x00,  /* Off */
    EVSYS_CHANNEL6_UPDI_SYNCH_gv   = 0x01,  /* UPDI SYNCH character */
    EVSYS_CHANNEL6_MVIO_gv         = 0x05,  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL6_RTC_OVF_gv      = 0x06,  /* Real Time Counter overflow */
    EVSYS_CHANNEL6_RTC_CMP_gv      = 0x07,  /* Real Time Counter compare */
    EVSYS_CHANNEL6_RTC_PIT_DIV8192_gv = 0x08,  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL6_RTC_PIT_DIV4096_gv = 0x09,  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL6_RTC_PIT_DIV2048_gv = 0x0A,  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL6_RTC_PIT_DIV1024_gv = 0x0B,  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL6_CCL_LUT0_gv     = 0x10,  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL6_CCL_LUT1_gv     = 0x11,  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL6_CCL_LUT2_gv     = 0x12,  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL6_CCL_LUT3_gv     = 0x13,  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL6_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL6_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL6_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL6_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL6_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL6_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL6_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL6_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL6_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL6_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL6_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL6_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    EVSYS_CHANNEL6_PORTG_PIN0_gv   = 0x40,  /* Port G Pin 0 */
    EVSYS_CHANNEL6_PORTG_PIN1_gv   = 0x41,  /* Port G Pin 1 */
    EVSYS_CHANNEL6_PORTG_PIN2_gv   = 0x42,  /* Port G Pin 2 */
    EVSYS_CHANNEL6_PORTG_PIN3_gv   = 0x43,  /* Port G Pin 3 */
    EVSYS_CHANNEL6_PORTG_PIN4_gv   = 0x44,  /* Port G Pin 4 */
    EVSYS_CHANNEL6_PORTG_PIN5_gv   = 0x45,  /* Port G Pin 5 */
    EVSYS_CHANNEL6_PORTG_PIN6_gv   = 0x46,  /* Port G Pin 6 */
    EVSYS_CHANNEL6_PORTG_PIN7_gv   = 0x47,  /* Port G Pin 7 */
    EVSYS_CHANNEL6_USART0_XCK_gv   = 0x60,  /* USART 0 XCK */
    EVSYS_CHANNEL6_USART1_XCK_gv   = 0x61,  /* USART 1 XCK */
    EVSYS_CHANNEL6_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL6_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL6_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL6_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL6_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL6_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    EVSYS_CHANNEL6_TCA0_OVF_LUNF_gv = 0x80,  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL6_TCA0_HUNF_gv    = 0x81,  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL6_TCA0_CMP0_LCMP0_gv = 0x84,  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL6_TCA0_CMP1_LCMP1_gv = 0x85,  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL6_TCA0_CMP2_LCMP2_gv = 0x86,  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL6_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL6_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL6_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL6_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL6_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL6_TCB0_CAPT_gv    = 0xA0,  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL6_TCB0_OVF_gv     = 0xA1,  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL6_TCB1_CAPT_gv    = 0xA2,  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL6_TCB1_OVF_gv     = 0xA3,  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL6_TCB2_CAPT_gv    = 0xA4,  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL6_TCB2_OVF_gv     = 0xA5,  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL6_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL6_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL6_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL6_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL6_TCD0_CMPBCLR_gv = 0xB0,  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL6_TCD0_CMPASET_gv = 0xB1,  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL6_TCD0_CMPBSET_gv = 0xB2,  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL6_TCD0_PROGEV_gv  = 0xB3   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL6_values_t;

/* Channel 6 generator select bit group configurations*/
typedef enum EVSYS_CHANNEL6_enum
{
    EVSYS_CHANNEL6_OFF_gc          = (EVSYS_CHANNEL6_OFF_gv << EVSYS_CHANNEL6_gp),  /* Off */
    EVSYS_CHANNEL6_UPDI_SYNCH_gc   = (EVSYS_CHANNEL6_UPDI_SYNCH_gv << EVSYS_CHANNEL6_gp),  /* UPDI SYNCH character */
    EVSYS_CHANNEL6_MVIO_gc         = (EVSYS_CHANNEL6_MVIO_gv << EVSYS_CHANNEL6_gp),  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL6_RTC_OVF_gc      = (EVSYS_CHANNEL6_RTC_OVF_gv << EVSYS_CHANNEL6_gp),  /* Real Time Counter overflow */
    EVSYS_CHANNEL6_RTC_CMP_gc      = (EVSYS_CHANNEL6_RTC_CMP_gv << EVSYS_CHANNEL6_gp),  /* Real Time Counter compare */
    EVSYS_CHANNEL6_RTC_PIT_DIV8192_gc = (EVSYS_CHANNEL6_RTC_PIT_DIV8192_gv << EVSYS_CHANNEL6_gp),  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL6_RTC_PIT_DIV4096_gc = (EVSYS_CHANNEL6_RTC_PIT_DIV4096_gv << EVSYS_CHANNEL6_gp),  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL6_RTC_PIT_DIV2048_gc = (EVSYS_CHANNEL6_RTC_PIT_DIV2048_gv << EVSYS_CHANNEL6_gp),  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL6_RTC_PIT_DIV1024_gc = (EVSYS_CHANNEL6_RTC_PIT_DIV1024_gv << EVSYS_CHANNEL6_gp),  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL6_CCL_LUT0_gc     = (EVSYS_CHANNEL6_CCL_LUT0_gv << EVSYS_CHANNEL6_gp),  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL6_CCL_LUT1_gc     = (EVSYS_CHANNEL6_CCL_LUT1_gv << EVSYS_CHANNEL6_gp),  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL6_CCL_LUT2_gc     = (EVSYS_CHANNEL6_CCL_LUT2_gv << EVSYS_CHANNEL6_gp),  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL6_CCL_LUT3_gc     = (EVSYS_CHANNEL6_CCL_LUT3_gv << EVSYS_CHANNEL6_gp),  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL6_CCL_LUT4_gc     = (EVSYS_CHANNEL6_CCL_LUT4_gv << EVSYS_CHANNEL6_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL6_CCL_LUT5_gc     = (EVSYS_CHANNEL6_CCL_LUT5_gv << EVSYS_CHANNEL6_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL6_AC0_OUT_gc      = (EVSYS_CHANNEL6_AC0_OUT_gv << EVSYS_CHANNEL6_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL6_AC1_OUT_gc      = (EVSYS_CHANNEL6_AC1_OUT_gv << EVSYS_CHANNEL6_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL6_AC2_OUT_gc      = (EVSYS_CHANNEL6_AC2_OUT_gv << EVSYS_CHANNEL6_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL6_ADC0_RESRDY_gc  = (EVSYS_CHANNEL6_ADC0_RESRDY_gv << EVSYS_CHANNEL6_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL6_ZCD0_gc         = (EVSYS_CHANNEL6_ZCD0_gv << EVSYS_CHANNEL6_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL6_ZCD1_gc         = (EVSYS_CHANNEL6_ZCD1_gv << EVSYS_CHANNEL6_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL6_ZCD2_gc         = (EVSYS_CHANNEL6_ZCD2_gv << EVSYS_CHANNEL6_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL6_OPAMP0_READY_gc = (EVSYS_CHANNEL6_OPAMP0_READY_gv << EVSYS_CHANNEL6_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL6_OPAMP1_READY_gc = (EVSYS_CHANNEL6_OPAMP1_READY_gv << EVSYS_CHANNEL6_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL6_OPAMP2_READY_gc = (EVSYS_CHANNEL6_OPAMP2_READY_gv << EVSYS_CHANNEL6_gp),  /* OPAMP2 Ready */
    EVSYS_CHANNEL6_PORTG_PIN0_gc   = (EVSYS_CHANNEL6_PORTG_PIN0_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 0 */
    EVSYS_CHANNEL6_PORTG_PIN1_gc   = (EVSYS_CHANNEL6_PORTG_PIN1_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 1 */
    EVSYS_CHANNEL6_PORTG_PIN2_gc   = (EVSYS_CHANNEL6_PORTG_PIN2_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 2 */
    EVSYS_CHANNEL6_PORTG_PIN3_gc   = (EVSYS_CHANNEL6_PORTG_PIN3_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 3 */
    EVSYS_CHANNEL6_PORTG_PIN4_gc   = (EVSYS_CHANNEL6_PORTG_PIN4_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 4 */
    EVSYS_CHANNEL6_PORTG_PIN5_gc   = (EVSYS_CHANNEL6_PORTG_PIN5_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 5 */
    EVSYS_CHANNEL6_PORTG_PIN6_gc   = (EVSYS_CHANNEL6_PORTG_PIN6_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 6 */
    EVSYS_CHANNEL6_PORTG_PIN7_gc   = (EVSYS_CHANNEL6_PORTG_PIN7_gv << EVSYS_CHANNEL6_gp),  /* Port G Pin 7 */
    EVSYS_CHANNEL6_USART0_XCK_gc   = (EVSYS_CHANNEL6_USART0_XCK_gv << EVSYS_CHANNEL6_gp),  /* USART 0 XCK */
    EVSYS_CHANNEL6_USART1_XCK_gc   = (EVSYS_CHANNEL6_USART1_XCK_gv << EVSYS_CHANNEL6_gp),  /* USART 1 XCK */
    EVSYS_CHANNEL6_USART2_XCK_gc   = (EVSYS_CHANNEL6_USART2_XCK_gv << EVSYS_CHANNEL6_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL6_USART3_XCK_gc   = (EVSYS_CHANNEL6_USART3_XCK_gv << EVSYS_CHANNEL6_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL6_USART4_XCK_gc   = (EVSYS_CHANNEL6_USART4_XCK_gv << EVSYS_CHANNEL6_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL6_USART5_XCK_gc   = (EVSYS_CHANNEL6_USART5_XCK_gv << EVSYS_CHANNEL6_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL6_SPI0_SCK_gc     = (EVSYS_CHANNEL6_SPI0_SCK_gv << EVSYS_CHANNEL6_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL6_SPI1_SCK_gc     = (EVSYS_CHANNEL6_SPI1_SCK_gv << EVSYS_CHANNEL6_gp),  /* SPI 1 SCK */
    EVSYS_CHANNEL6_TCA0_OVF_LUNF_gc = (EVSYS_CHANNEL6_TCA0_OVF_LUNF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL6_TCA0_HUNF_gc    = (EVSYS_CHANNEL6_TCA0_HUNF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL6_TCA0_CMP0_LCMP0_gc = (EVSYS_CHANNEL6_TCA0_CMP0_LCMP0_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL6_TCA0_CMP1_LCMP1_gc = (EVSYS_CHANNEL6_TCA0_CMP1_LCMP1_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL6_TCA0_CMP2_LCMP2_gc = (EVSYS_CHANNEL6_TCA0_CMP2_LCMP2_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL6_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL6_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL6_TCA1_HUNF_gc    = (EVSYS_CHANNEL6_TCA1_HUNF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL6_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL6_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL6_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL6_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL6_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL6_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL6_TCB0_CAPT_gc    = (EVSYS_CHANNEL6_TCB0_CAPT_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL6_TCB0_OVF_gc     = (EVSYS_CHANNEL6_TCB0_OVF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL6_TCB1_CAPT_gc    = (EVSYS_CHANNEL6_TCB1_CAPT_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL6_TCB1_OVF_gc     = (EVSYS_CHANNEL6_TCB1_OVF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL6_TCB2_CAPT_gc    = (EVSYS_CHANNEL6_TCB2_CAPT_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL6_TCB2_OVF_gc     = (EVSYS_CHANNEL6_TCB2_OVF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL6_TCB3_CAPT_gc    = (EVSYS_CHANNEL6_TCB3_CAPT_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL6_TCB3_OVF_gc     = (EVSYS_CHANNEL6_TCB3_OVF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL6_TCB4_CAPT_gc    = (EVSYS_CHANNEL6_TCB4_CAPT_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL6_TCB4_OVF_gc     = (EVSYS_CHANNEL6_TCB4_OVF_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL6_TCD0_CMPBCLR_gc = (EVSYS_CHANNEL6_TCD0_CMPBCLR_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL6_TCD0_CMPASET_gc = (EVSYS_CHANNEL6_TCD0_CMPASET_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL6_TCD0_CMPBSET_gc = (EVSYS_CHANNEL6_TCD0_CMPBSET_gv << EVSYS_CHANNEL6_gp),  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL6_TCD0_PROGEV_gc  = (EVSYS_CHANNEL6_TCD0_PROGEV_gv << EVSYS_CHANNEL6_gp)   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL6_t;

/* Channel 7 generator select bit group values */
typedef enum EVSYS_CHANNEL7_VALUES_enum
{
    EVSYS_CHANNEL7_OFF_gv          = 0x00,  /* Off */
    EVSYS_CHANNEL7_UPDI_SYNCH_gv   = 0x01,  /* UPDI SYNCH character */
    EVSYS_CHANNEL7_MVIO_gv         = 0x05,  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL7_RTC_OVF_gv      = 0x06,  /* Real Time Counter overflow */
    EVSYS_CHANNEL7_RTC_CMP_gv      = 0x07,  /* Real Time Counter compare */
    EVSYS_CHANNEL7_RTC_PIT_DIV512_gv = 0x08,  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL7_RTC_PIT_DIV256_gv = 0x09,  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL7_RTC_PIT_DIV128_gv = 0x0A,  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL7_RTC_PIT_DIV64_gv = 0x0B,  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL7_CCL_LUT0_gv     = 0x10,  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL7_CCL_LUT1_gv     = 0x11,  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL7_CCL_LUT2_gv     = 0x12,  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL7_CCL_LUT3_gv     = 0x13,  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL7_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL7_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL7_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL7_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL7_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL7_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL7_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL7_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL7_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL7_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL7_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL7_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    EVSYS_CHANNEL7_PORTG_PIN0_gv   = 0x40,  /* Port G Pin 0 */
    EVSYS_CHANNEL7_PORTG_PIN1_gv   = 0x41,  /* Port G Pin 1 */
    EVSYS_CHANNEL7_PORTG_PIN2_gv   = 0x42,  /* Port G Pin 2 */
    EVSYS_CHANNEL7_PORTG_PIN3_gv   = 0x43,  /* Port G Pin 3 */
    EVSYS_CHANNEL7_PORTG_PIN4_gv   = 0x44,  /* Port G Pin 4 */
    EVSYS_CHANNEL7_PORTG_PIN5_gv   = 0x45,  /* Port G Pin 5 */
    EVSYS_CHANNEL7_PORTG_PIN6_gv   = 0x46,  /* Port G Pin 6 */
    EVSYS_CHANNEL7_PORTG_PIN7_gv   = 0x47,  /* Port G Pin 7 */
    EVSYS_CHANNEL7_USART0_XCK_gv   = 0x60,  /* USART 0 XCK */
    EVSYS_CHANNEL7_USART1_XCK_gv   = 0x61,  /* USART 1 XCK */
    EVSYS_CHANNEL7_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL7_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL7_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL7_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL7_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL7_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    EVSYS_CHANNEL7_TCA0_OVF_LUNF_gv = 0x80,  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL7_TCA0_HUNF_gv    = 0x81,  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL7_TCA0_CMP0_LCMP0_gv = 0x84,  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL7_TCA0_CMP1_LCMP1_gv = 0x85,  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL7_TCA0_CMP2_LCMP2_gv = 0x86,  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL7_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL7_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL7_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL7_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL7_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL7_TCB0_CAPT_gv    = 0xA0,  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL7_TCB0_OVF_gv     = 0xA1,  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL7_TCB1_CAPT_gv    = 0xA2,  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL7_TCB1_OVF_gv     = 0xA3,  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL7_TCB2_CAPT_gv    = 0xA4,  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL7_TCB2_OVF_gv     = 0xA5,  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL7_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL7_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL7_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL7_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL7_TCD0_CMPBCLR_gv = 0xB0,  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL7_TCD0_CMPASET_gv = 0xB1,  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL7_TCD0_CMPBSET_gv = 0xB2,  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL7_TCD0_PROGEV_gv  = 0xB3   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL7_values_t;

/* Channel 7 generator select bit group configurations*/
typedef enum EVSYS_CHANNEL7_enum
{
    EVSYS_CHANNEL7_OFF_gc          = (EVSYS_CHANNEL7_OFF_gv << EVSYS_CHANNEL7_gp),  /* Off */
    EVSYS_CHANNEL7_UPDI_SYNCH_gc   = (EVSYS_CHANNEL7_UPDI_SYNCH_gv << EVSYS_CHANNEL7_gp),  /* UPDI SYNCH character */
    EVSYS_CHANNEL7_MVIO_gc         = (EVSYS_CHANNEL7_MVIO_gv << EVSYS_CHANNEL7_gp),  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL7_RTC_OVF_gc      = (EVSYS_CHANNEL7_RTC_OVF_gv << EVSYS_CHANNEL7_gp),  /* Real Time Counter overflow */
    EVSYS_CHANNEL7_RTC_CMP_gc      = (EVSYS_CHANNEL7_RTC_CMP_gv << EVSYS_CHANNEL7_gp),  /* Real Time Counter compare */
    EVSYS_CHANNEL7_RTC_PIT_DIV512_gc = (EVSYS_CHANNEL7_RTC_PIT_DIV512_gv << EVSYS_CHANNEL7_gp),  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL7_RTC_PIT_DIV256_gc = (EVSYS_CHANNEL7_RTC_PIT_DIV256_gv << EVSYS_CHANNEL7_gp),  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL7_RTC_PIT_DIV128_gc = (EVSYS_CHANNEL7_RTC_PIT_DIV128_gv << EVSYS_CHANNEL7_gp),  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL7_RTC_PIT_DIV64_gc = (EVSYS_CHANNEL7_RTC_PIT_DIV64_gv << EVSYS_CHANNEL7_gp),  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL7_CCL_LUT0_gc     = (EVSYS_CHANNEL7_CCL_LUT0_gv << EVSYS_CHANNEL7_gp),  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL7_CCL_LUT1_gc     = (EVSYS_CHANNEL7_CCL_LUT1_gv << EVSYS_CHANNEL7_gp),  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL7_CCL_LUT2_gc     = (EVSYS_CHANNEL7_CCL_LUT2_gv << EVSYS_CHANNEL7_gp),  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL7_CCL_LUT3_gc     = (EVSYS_CHANNEL7_CCL_LUT3_gv << EVSYS_CHANNEL7_gp),  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL7_CCL_LUT4_gc     = (EVSYS_CHANNEL7_CCL_LUT4_gv << EVSYS_CHANNEL7_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL7_CCL_LUT5_gc     = (EVSYS_CHANNEL7_CCL_LUT5_gv << EVSYS_CHANNEL7_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL7_AC0_OUT_gc      = (EVSYS_CHANNEL7_AC0_OUT_gv << EVSYS_CHANNEL7_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL7_AC1_OUT_gc      = (EVSYS_CHANNEL7_AC1_OUT_gv << EVSYS_CHANNEL7_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL7_AC2_OUT_gc      = (EVSYS_CHANNEL7_AC2_OUT_gv << EVSYS_CHANNEL7_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL7_ADC0_RESRDY_gc  = (EVSYS_CHANNEL7_ADC0_RESRDY_gv << EVSYS_CHANNEL7_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL7_ZCD0_gc         = (EVSYS_CHANNEL7_ZCD0_gv << EVSYS_CHANNEL7_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL7_ZCD1_gc         = (EVSYS_CHANNEL7_ZCD1_gv << EVSYS_CHANNEL7_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL7_ZCD2_gc         = (EVSYS_CHANNEL7_ZCD2_gv << EVSYS_CHANNEL7_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL7_OPAMP0_READY_gc = (EVSYS_CHANNEL7_OPAMP0_READY_gv << EVSYS_CHANNEL7_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL7_OPAMP1_READY_gc = (EVSYS_CHANNEL7_OPAMP1_READY_gv << EVSYS_CHANNEL7_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL7_OPAMP2_READY_gc = (EVSYS_CHANNEL7_OPAMP2_READY_gv << EVSYS_CHANNEL7_gp),  /* OPAMP2 Ready */
    EVSYS_CHANNEL7_PORTG_PIN0_gc   = (EVSYS_CHANNEL7_PORTG_PIN0_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 0 */
    EVSYS_CHANNEL7_PORTG_PIN1_gc   = (EVSYS_CHANNEL7_PORTG_PIN1_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 1 */
    EVSYS_CHANNEL7_PORTG_PIN2_gc   = (EVSYS_CHANNEL7_PORTG_PIN2_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 2 */
    EVSYS_CHANNEL7_PORTG_PIN3_gc   = (EVSYS_CHANNEL7_PORTG_PIN3_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 3 */
    EVSYS_CHANNEL7_PORTG_PIN4_gc   = (EVSYS_CHANNEL7_PORTG_PIN4_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 4 */
    EVSYS_CHANNEL7_PORTG_PIN5_gc   = (EVSYS_CHANNEL7_PORTG_PIN5_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 5 */
    EVSYS_CHANNEL7_PORTG_PIN6_gc   = (EVSYS_CHANNEL7_PORTG_PIN6_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 6 */
    EVSYS_CHANNEL7_PORTG_PIN7_gc   = (EVSYS_CHANNEL7_PORTG_PIN7_gv << EVSYS_CHANNEL7_gp),  /* Port G Pin 7 */
    EVSYS_CHANNEL7_USART0_XCK_gc   = (EVSYS_CHANNEL7_USART0_XCK_gv << EVSYS_CHANNEL7_gp),  /* USART 0 XCK */
    EVSYS_CHANNEL7_USART1_XCK_gc   = (EVSYS_CHANNEL7_USART1_XCK_gv << EVSYS_CHANNEL7_gp),  /* USART 1 XCK */
    EVSYS_CHANNEL7_USART2_XCK_gc   = (EVSYS_CHANNEL7_USART2_XCK_gv << EVSYS_CHANNEL7_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL7_USART3_XCK_gc   = (EVSYS_CHANNEL7_USART3_XCK_gv << EVSYS_CHANNEL7_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL7_USART4_XCK_gc   = (EVSYS_CHANNEL7_USART4_XCK_gv << EVSYS_CHANNEL7_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL7_USART5_XCK_gc   = (EVSYS_CHANNEL7_USART5_XCK_gv << EVSYS_CHANNEL7_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL7_SPI0_SCK_gc     = (EVSYS_CHANNEL7_SPI0_SCK_gv << EVSYS_CHANNEL7_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL7_SPI1_SCK_gc     = (EVSYS_CHANNEL7_SPI1_SCK_gv << EVSYS_CHANNEL7_gp),  /* SPI 1 SCK */
    EVSYS_CHANNEL7_TCA0_OVF_LUNF_gc = (EVSYS_CHANNEL7_TCA0_OVF_LUNF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL7_TCA0_HUNF_gc    = (EVSYS_CHANNEL7_TCA0_HUNF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL7_TCA0_CMP0_LCMP0_gc = (EVSYS_CHANNEL7_TCA0_CMP0_LCMP0_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL7_TCA0_CMP1_LCMP1_gc = (EVSYS_CHANNEL7_TCA0_CMP1_LCMP1_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL7_TCA0_CMP2_LCMP2_gc = (EVSYS_CHANNEL7_TCA0_CMP2_LCMP2_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL7_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL7_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL7_TCA1_HUNF_gc    = (EVSYS_CHANNEL7_TCA1_HUNF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL7_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL7_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL7_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL7_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL7_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL7_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL7_TCB0_CAPT_gc    = (EVSYS_CHANNEL7_TCB0_CAPT_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL7_TCB0_OVF_gc     = (EVSYS_CHANNEL7_TCB0_OVF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL7_TCB1_CAPT_gc    = (EVSYS_CHANNEL7_TCB1_CAPT_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL7_TCB1_OVF_gc     = (EVSYS_CHANNEL7_TCB1_OVF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL7_TCB2_CAPT_gc    = (EVSYS_CHANNEL7_TCB2_CAPT_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL7_TCB2_OVF_gc     = (EVSYS_CHANNEL7_TCB2_OVF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL7_TCB3_CAPT_gc    = (EVSYS_CHANNEL7_TCB3_CAPT_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL7_TCB3_OVF_gc     = (EVSYS_CHANNEL7_TCB3_OVF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL7_TCB4_CAPT_gc    = (EVSYS_CHANNEL7_TCB4_CAPT_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL7_TCB4_OVF_gc     = (EVSYS_CHANNEL7_TCB4_OVF_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL7_TCD0_CMPBCLR_gc = (EVSYS_CHANNEL7_TCD0_CMPBCLR_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL7_TCD0_CMPASET_gc = (EVSYS_CHANNEL7_TCD0_CMPASET_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL7_TCD0_CMPBSET_gc = (EVSYS_CHANNEL7_TCD0_CMPBSET_gv << EVSYS_CHANNEL7_gp),  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL7_TCD0_PROGEV_gc  = (EVSYS_CHANNEL7_TCD0_PROGEV_gv << EVSYS_CHANNEL7_gp)   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL7_t;

/* Channel 8 generator select bit group values */
typedef enum EVSYS_CHANNEL8_VALUES_enum
{
    EVSYS_CHANNEL8_OFF_gv          = 0x00,  /* Off */
    EVSYS_CHANNEL8_UPDI_SYNCH_gv   = 0x01,  /* UPDI SYNCH character */
    EVSYS_CHANNEL8_MVIO_gv         = 0x05,  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL8_RTC_OVF_gv      = 0x06,  /* Real Time Counter overflow */
    EVSYS_CHANNEL8_RTC_CMP_gv      = 0x07,  /* Real Time Counter compare */
    EVSYS_CHANNEL8_RTC_PIT_DIV8192_gv = 0x08,  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL8_RTC_PIT_DIV4096_gv = 0x09,  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL8_RTC_PIT_DIV2048_gv = 0x0A,  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL8_RTC_PIT_DIV1024_gv = 0x0B,  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL8_CCL_LUT0_gv     = 0x10,  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL8_CCL_LUT1_gv     = 0x11,  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL8_CCL_LUT2_gv     = 0x12,  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL8_CCL_LUT3_gv     = 0x13,  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL8_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL8_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL8_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL8_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL8_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL8_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL8_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL8_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL8_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL8_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL8_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL8_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    EVSYS_CHANNEL8_USART0_XCK_gv   = 0x60,  /* USART 0 XCK */
    EVSYS_CHANNEL8_USART1_XCK_gv   = 0x61,  /* USART 1 XCK */
    EVSYS_CHANNEL8_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL8_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL8_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL8_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL8_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL8_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    EVSYS_CHANNEL8_TCA0_OVF_LUNF_gv = 0x80,  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL8_TCA0_HUNF_gv    = 0x81,  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL8_TCA0_CMP0_LCMP0_gv = 0x84,  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL8_TCA0_CMP1_LCMP1_gv = 0x85,  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL8_TCA0_CMP2_LCMP2_gv = 0x86,  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL8_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL8_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL8_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL8_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL8_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL8_TCB0_CAPT_gv    = 0xA0,  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL8_TCB0_OVF_gv     = 0xA1,  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL8_TCB1_CAPT_gv    = 0xA2,  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL8_TCB1_OVF_gv     = 0xA3,  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL8_TCB2_CAPT_gv    = 0xA4,  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL8_TCB2_OVF_gv     = 0xA5,  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL8_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL8_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL8_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL8_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL8_TCD0_CMPBCLR_gv = 0xB0,  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL8_TCD0_CMPASET_gv = 0xB1,  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL8_TCD0_CMPBSET_gv = 0xB2,  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL8_TCD0_PROGEV_gv  = 0xB3   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL8_values_t;

/* Channel 8 generator select bit group configurations*/
typedef enum EVSYS_CHANNEL8_enum
{
    EVSYS_CHANNEL8_OFF_gc          = (EVSYS_CHANNEL8_OFF_gv << EVSYS_CHANNEL8_gp),  /* Off */
    EVSYS_CHANNEL8_UPDI_SYNCH_gc   = (EVSYS_CHANNEL8_UPDI_SYNCH_gv << EVSYS_CHANNEL8_gp),  /* UPDI SYNCH character */
    EVSYS_CHANNEL8_MVIO_gc         = (EVSYS_CHANNEL8_MVIO_gv << EVSYS_CHANNEL8_gp),  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL8_RTC_OVF_gc      = (EVSYS_CHANNEL8_RTC_OVF_gv << EVSYS_CHANNEL8_gp),  /* Real Time Counter overflow */
    EVSYS_CHANNEL8_RTC_CMP_gc      = (EVSYS_CHANNEL8_RTC_CMP_gv << EVSYS_CHANNEL8_gp),  /* Real Time Counter compare */
    EVSYS_CHANNEL8_RTC_PIT_DIV8192_gc = (EVSYS_CHANNEL8_RTC_PIT_DIV8192_gv << EVSYS_CHANNEL8_gp),  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL8_RTC_PIT_DIV4096_gc = (EVSYS_CHANNEL8_RTC_PIT_DIV4096_gv << EVSYS_CHANNEL8_gp),  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL8_RTC_PIT_DIV2048_gc = (EVSYS_CHANNEL8_RTC_PIT_DIV2048_gv << EVSYS_CHANNEL8_gp),  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL8_RTC_PIT_DIV1024_gc = (EVSYS_CHANNEL8_RTC_PIT_DIV1024_gv << EVSYS_CHANNEL8_gp),  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL8_CCL_LUT0_gc     = (EVSYS_CHANNEL8_CCL_LUT0_gv << EVSYS_CHANNEL8_gp),  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL8_CCL_LUT1_gc     = (EVSYS_CHANNEL8_CCL_LUT1_gv << EVSYS_CHANNEL8_gp),  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL8_CCL_LUT2_gc     = (EVSYS_CHANNEL8_CCL_LUT2_gv << EVSYS_CHANNEL8_gp),  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL8_CCL_LUT3_gc     = (EVSYS_CHANNEL8_CCL_LUT3_gv << EVSYS_CHANNEL8_gp),  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL8_CCL_LUT4_gc     = (EVSYS_CHANNEL8_CCL_LUT4_gv << EVSYS_CHANNEL8_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL8_CCL_LUT5_gc     = (EVSYS_CHANNEL8_CCL_LUT5_gv << EVSYS_CHANNEL8_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL8_AC0_OUT_gc      = (EVSYS_CHANNEL8_AC0_OUT_gv << EVSYS_CHANNEL8_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL8_AC1_OUT_gc      = (EVSYS_CHANNEL8_AC1_OUT_gv << EVSYS_CHANNEL8_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL8_AC2_OUT_gc      = (EVSYS_CHANNEL8_AC2_OUT_gv << EVSYS_CHANNEL8_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL8_ADC0_RESRDY_gc  = (EVSYS_CHANNEL8_ADC0_RESRDY_gv << EVSYS_CHANNEL8_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL8_ZCD0_gc         = (EVSYS_CHANNEL8_ZCD0_gv << EVSYS_CHANNEL8_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL8_ZCD1_gc         = (EVSYS_CHANNEL8_ZCD1_gv << EVSYS_CHANNEL8_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL8_ZCD2_gc         = (EVSYS_CHANNEL8_ZCD2_gv << EVSYS_CHANNEL8_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL8_OPAMP0_READY_gc = (EVSYS_CHANNEL8_OPAMP0_READY_gv << EVSYS_CHANNEL8_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL8_OPAMP1_READY_gc = (EVSYS_CHANNEL8_OPAMP1_READY_gv << EVSYS_CHANNEL8_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL8_OPAMP2_READY_gc = (EVSYS_CHANNEL8_OPAMP2_READY_gv << EVSYS_CHANNEL8_gp),  /* OPAMP2 Ready */
    EVSYS_CHANNEL8_USART0_XCK_gc   = (EVSYS_CHANNEL8_USART0_XCK_gv << EVSYS_CHANNEL8_gp),  /* USART 0 XCK */
    EVSYS_CHANNEL8_USART1_XCK_gc   = (EVSYS_CHANNEL8_USART1_XCK_gv << EVSYS_CHANNEL8_gp),  /* USART 1 XCK */
    EVSYS_CHANNEL8_USART2_XCK_gc   = (EVSYS_CHANNEL8_USART2_XCK_gv << EVSYS_CHANNEL8_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL8_USART3_XCK_gc   = (EVSYS_CHANNEL8_USART3_XCK_gv << EVSYS_CHANNEL8_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL8_USART4_XCK_gc   = (EVSYS_CHANNEL8_USART4_XCK_gv << EVSYS_CHANNEL8_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL8_USART5_XCK_gc   = (EVSYS_CHANNEL8_USART5_XCK_gv << EVSYS_CHANNEL8_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL8_SPI0_SCK_gc     = (EVSYS_CHANNEL8_SPI0_SCK_gv << EVSYS_CHANNEL8_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL8_SPI1_SCK_gc     = (EVSYS_CHANNEL8_SPI1_SCK_gv << EVSYS_CHANNEL8_gp),  /* SPI 1 SCK */
    EVSYS_CHANNEL8_TCA0_OVF_LUNF_gc = (EVSYS_CHANNEL8_TCA0_OVF_LUNF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL8_TCA0_HUNF_gc    = (EVSYS_CHANNEL8_TCA0_HUNF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL8_TCA0_CMP0_LCMP0_gc = (EVSYS_CHANNEL8_TCA0_CMP0_LCMP0_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL8_TCA0_CMP1_LCMP1_gc = (EVSYS_CHANNEL8_TCA0_CMP1_LCMP1_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL8_TCA0_CMP2_LCMP2_gc = (EVSYS_CHANNEL8_TCA0_CMP2_LCMP2_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL8_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL8_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL8_TCA1_HUNF_gc    = (EVSYS_CHANNEL8_TCA1_HUNF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL8_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL8_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL8_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL8_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL8_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL8_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL8_TCB0_CAPT_gc    = (EVSYS_CHANNEL8_TCB0_CAPT_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL8_TCB0_OVF_gc     = (EVSYS_CHANNEL8_TCB0_OVF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL8_TCB1_CAPT_gc    = (EVSYS_CHANNEL8_TCB1_CAPT_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL8_TCB1_OVF_gc     = (EVSYS_CHANNEL8_TCB1_OVF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL8_TCB2_CAPT_gc    = (EVSYS_CHANNEL8_TCB2_CAPT_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL8_TCB2_OVF_gc     = (EVSYS_CHANNEL8_TCB2_OVF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL8_TCB3_CAPT_gc    = (EVSYS_CHANNEL8_TCB3_CAPT_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL8_TCB3_OVF_gc     = (EVSYS_CHANNEL8_TCB3_OVF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL8_TCB4_CAPT_gc    = (EVSYS_CHANNEL8_TCB4_CAPT_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL8_TCB4_OVF_gc     = (EVSYS_CHANNEL8_TCB4_OVF_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL8_TCD0_CMPBCLR_gc = (EVSYS_CHANNEL8_TCD0_CMPBCLR_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL8_TCD0_CMPASET_gc = (EVSYS_CHANNEL8_TCD0_CMPASET_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL8_TCD0_CMPBSET_gc = (EVSYS_CHANNEL8_TCD0_CMPBSET_gv << EVSYS_CHANNEL8_gp),  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL8_TCD0_PROGEV_gc  = (EVSYS_CHANNEL8_TCD0_PROGEV_gv << EVSYS_CHANNEL8_gp)   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL8_t;

/* Channel 9 generator select bit group values */
typedef enum EVSYS_CHANNEL9_VALUES_enum
{
    EVSYS_CHANNEL9_OFF_gv          = 0x00,  /* Off */
    EVSYS_CHANNEL9_UPDI_SYNCH_gv   = 0x01,  /* UPDI SYNCH character */
    EVSYS_CHANNEL9_MVIO_gv         = 0x05,  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL9_RTC_OVF_gv      = 0x06,  /* Real Time Counter overflow */
    EVSYS_CHANNEL9_RTC_CMP_gv      = 0x07,  /* Real Time Counter compare */
    EVSYS_CHANNEL9_RTC_PIT_DIV512_gv = 0x08,  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL9_RTC_PIT_DIV256_gv = 0x09,  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL9_RTC_PIT_DIV128_gv = 0x0A,  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL9_RTC_PIT_DIV64_gv = 0x0B,  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL9_CCL_LUT0_gv     = 0x10,  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL9_CCL_LUT1_gv     = 0x11,  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL9_CCL_LUT2_gv     = 0x12,  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL9_CCL_LUT3_gv     = 0x13,  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL9_CCL_LUT4_gv     = 0x14,  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL9_CCL_LUT5_gv     = 0x15,  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL9_AC0_OUT_gv      = 0x20,  /* Analog Comparator 0 out */
    EVSYS_CHANNEL9_AC1_OUT_gv      = 0x21,  /* Analog Comparator 1 out */
    EVSYS_CHANNEL9_AC2_OUT_gv      = 0x22,  /* Analog Comparator 2 out */
    EVSYS_CHANNEL9_ADC0_RESRDY_gv  = 0x24,  /* ADC 0 Result Ready */
    EVSYS_CHANNEL9_ZCD0_gv         = 0x30,  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL9_ZCD1_gv         = 0x31,  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL9_ZCD2_gv         = 0x32,  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL9_OPAMP0_READY_gv = 0x34,  /* OPAMP0 Ready */
    EVSYS_CHANNEL9_OPAMP1_READY_gv = 0x35,  /* OPAMP1 Ready */
    EVSYS_CHANNEL9_OPAMP2_READY_gv = 0x36,  /* OPAMP2 Ready */
    EVSYS_CHANNEL9_USART0_XCK_gv   = 0x60,  /* USART 0 XCK */
    EVSYS_CHANNEL9_USART1_XCK_gv   = 0x61,  /* USART 1 XCK */
    EVSYS_CHANNEL9_USART2_XCK_gv   = 0x62,  /* USART 2 XCK */
    EVSYS_CHANNEL9_USART3_XCK_gv   = 0x63,  /* USART 3 XCK */
    EVSYS_CHANNEL9_USART4_XCK_gv   = 0x64,  /* USART 4 XCK */
    EVSYS_CHANNEL9_USART5_XCK_gv   = 0x65,  /* USART 5 XCK */
    EVSYS_CHANNEL9_SPI0_SCK_gv     = 0x68,  /* SPI 0 SCK */
    EVSYS_CHANNEL9_SPI1_SCK_gv     = 0x69,  /* SPI 1 SCK */
    EVSYS_CHANNEL9_TCA0_OVF_LUNF_gv = 0x80,  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL9_TCA0_HUNF_gv    = 0x81,  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL9_TCA0_CMP0_LCMP0_gv = 0x84,  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL9_TCA0_CMP1_LCMP1_gv = 0x85,  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL9_TCA0_CMP2_LCMP2_gv = 0x86,  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL9_TCA1_OVF_LUNF_gv = 0x88,  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL9_TCA1_HUNF_gv    = 0x89,  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL9_TCA1_CMP0_LCMP0_gv = 0x8C,  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL9_TCA1_CMP1_LCMP1_gv = 0x8D,  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL9_TCA1_CMP2_LCMP2_gv = 0x8E,  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL9_TCB0_CAPT_gv    = 0xA0,  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL9_TCB0_OVF_gv     = 0xA1,  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL9_TCB1_CAPT_gv    = 0xA2,  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL9_TCB1_OVF_gv     = 0xA3,  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL9_TCB2_CAPT_gv    = 0xA4,  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL9_TCB2_OVF_gv     = 0xA5,  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL9_TCB3_CAPT_gv    = 0xA6,  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL9_TCB3_OVF_gv     = 0xA7,  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL9_TCB4_CAPT_gv    = 0xA8,  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL9_TCB4_OVF_gv     = 0xA9,  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL9_TCD0_CMPBCLR_gv = 0xB0,  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL9_TCD0_CMPASET_gv = 0xB1,  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL9_TCD0_CMPBSET_gv = 0xB2,  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL9_TCD0_PROGEV_gv  = 0xB3   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL9_values_t;

/* Channel 9 generator select bit group configurations*/
typedef enum EVSYS_CHANNEL9_enum
{
    EVSYS_CHANNEL9_OFF_gc          = (EVSYS_CHANNEL9_OFF_gv << EVSYS_CHANNEL9_gp),  /* Off */
    EVSYS_CHANNEL9_UPDI_SYNCH_gc   = (EVSYS_CHANNEL9_UPDI_SYNCH_gv << EVSYS_CHANNEL9_gp),  /* UPDI SYNCH character */
    EVSYS_CHANNEL9_MVIO_gc         = (EVSYS_CHANNEL9_MVIO_gv << EVSYS_CHANNEL9_gp),  /* MVIO VDDIO2 OK */
    EVSYS_CHANNEL9_RTC_OVF_gc      = (EVSYS_CHANNEL9_RTC_OVF_gv << EVSYS_CHANNEL9_gp),  /* Real Time Counter overflow */
    EVSYS_CHANNEL9_RTC_CMP_gc      = (EVSYS_CHANNEL9_RTC_CMP_gv << EVSYS_CHANNEL9_gp),  /* Real Time Counter compare */
    EVSYS_CHANNEL9_RTC_PIT_DIV512_gc = (EVSYS_CHANNEL9_RTC_PIT_DIV512_gv << EVSYS_CHANNEL9_gp),  /* Periodic Interrupt Timer output 0 */
    EVSYS_CHANNEL9_RTC_PIT_DIV256_gc = (EVSYS_CHANNEL9_RTC_PIT_DIV256_gv << EVSYS_CHANNEL9_gp),  /* Periodic Interrupt Timer output 1 */
    EVSYS_CHANNEL9_RTC_PIT_DIV128_gc = (EVSYS_CHANNEL9_RTC_PIT_DIV128_gv << EVSYS_CHANNEL9_gp),  /* Periodic Interrupt Timer output 2 */
    EVSYS_CHANNEL9_RTC_PIT_DIV64_gc = (EVSYS_CHANNEL9_RTC_PIT_DIV64_gv << EVSYS_CHANNEL9_gp),  /* Periodic Interrupt Timer output 3 */
    EVSYS_CHANNEL9_CCL_LUT0_gc     = (EVSYS_CHANNEL9_CCL_LUT0_gv << EVSYS_CHANNEL9_gp),  /* Configurable Custom Logic LUT0 */
    EVSYS_CHANNEL9_CCL_LUT1_gc     = (EVSYS_CHANNEL9_CCL_LUT1_gv << EVSYS_CHANNEL9_gp),  /* Configurable Custom Logic LUT1 */
    EVSYS_CHANNEL9_CCL_LUT2_gc     = (EVSYS_CHANNEL9_CCL_LUT2_gv << EVSYS_CHANNEL9_gp),  /* Configurable Custom Logic LUT2 */
    EVSYS_CHANNEL9_CCL_LUT3_gc     = (EVSYS_CHANNEL9_CCL_LUT3_gv << EVSYS_CHANNEL9_gp),  /* Configurable Custom Logic LUT3 */
    EVSYS_CHANNEL9_CCL_LUT4_gc     = (EVSYS_CHANNEL9_CCL_LUT4_gv << EVSYS_CHANNEL9_gp),  /* Configurable Custom Logic LUT4 */
    EVSYS_CHANNEL9_CCL_LUT5_gc     = (EVSYS_CHANNEL9_CCL_LUT5_gv << EVSYS_CHANNEL9_gp),  /* Configurable Custom Logic LUT5 */
    EVSYS_CHANNEL9_AC0_OUT_gc      = (EVSYS_CHANNEL9_AC0_OUT_gv << EVSYS_CHANNEL9_gp),  /* Analog Comparator 0 out */
    EVSYS_CHANNEL9_AC1_OUT_gc      = (EVSYS_CHANNEL9_AC1_OUT_gv << EVSYS_CHANNEL9_gp),  /* Analog Comparator 1 out */
    EVSYS_CHANNEL9_AC2_OUT_gc      = (EVSYS_CHANNEL9_AC2_OUT_gv << EVSYS_CHANNEL9_gp),  /* Analog Comparator 2 out */
    EVSYS_CHANNEL9_ADC0_RESRDY_gc  = (EVSYS_CHANNEL9_ADC0_RESRDY_gv << EVSYS_CHANNEL9_gp),  /* ADC 0 Result Ready */
    EVSYS_CHANNEL9_ZCD0_gc         = (EVSYS_CHANNEL9_ZCD0_gv << EVSYS_CHANNEL9_gp),  /* Zero Cross Detect 0 out */
    EVSYS_CHANNEL9_ZCD1_gc         = (EVSYS_CHANNEL9_ZCD1_gv << EVSYS_CHANNEL9_gp),  /* Zero Cross Detect 1 out */
    EVSYS_CHANNEL9_ZCD2_gc         = (EVSYS_CHANNEL9_ZCD2_gv << EVSYS_CHANNEL9_gp),  /* Zero Cross Detect 2 out */
    EVSYS_CHANNEL9_OPAMP0_READY_gc = (EVSYS_CHANNEL9_OPAMP0_READY_gv << EVSYS_CHANNEL9_gp),  /* OPAMP0 Ready */
    EVSYS_CHANNEL9_OPAMP1_READY_gc = (EVSYS_CHANNEL9_OPAMP1_READY_gv << EVSYS_CHANNEL9_gp),  /* OPAMP1 Ready */
    EVSYS_CHANNEL9_OPAMP2_READY_gc = (EVSYS_CHANNEL9_OPAMP2_READY_gv << EVSYS_CHANNEL9_gp),  /* OPAMP2 Ready */
    EVSYS_CHANNEL9_USART0_XCK_gc   = (EVSYS_CHANNEL9_USART0_XCK_gv << EVSYS_CHANNEL9_gp),  /* USART 0 XCK */
    EVSYS_CHANNEL9_USART1_XCK_gc   = (EVSYS_CHANNEL9_USART1_XCK_gv << EVSYS_CHANNEL9_gp),  /* USART 1 XCK */
    EVSYS_CHANNEL9_USART2_XCK_gc   = (EVSYS_CHANNEL9_USART2_XCK_gv << EVSYS_CHANNEL9_gp),  /* USART 2 XCK */
    EVSYS_CHANNEL9_USART3_XCK_gc   = (EVSYS_CHANNEL9_USART3_XCK_gv << EVSYS_CHANNEL9_gp),  /* USART 3 XCK */
    EVSYS_CHANNEL9_USART4_XCK_gc   = (EVSYS_CHANNEL9_USART4_XCK_gv << EVSYS_CHANNEL9_gp),  /* USART 4 XCK */
    EVSYS_CHANNEL9_USART5_XCK_gc   = (EVSYS_CHANNEL9_USART5_XCK_gv << EVSYS_CHANNEL9_gp),  /* USART 5 XCK */
    EVSYS_CHANNEL9_SPI0_SCK_gc     = (EVSYS_CHANNEL9_SPI0_SCK_gv << EVSYS_CHANNEL9_gp),  /* SPI 0 SCK */
    EVSYS_CHANNEL9_SPI1_SCK_gc     = (EVSYS_CHANNEL9_SPI1_SCK_gv << EVSYS_CHANNEL9_gp),  /* SPI 1 SCK */
    EVSYS_CHANNEL9_TCA0_OVF_LUNF_gc = (EVSYS_CHANNEL9_TCA0_OVF_LUNF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A0 overflow / low byte timer underflow */
    EVSYS_CHANNEL9_TCA0_HUNF_gc    = (EVSYS_CHANNEL9_TCA0_HUNF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A0 high byte timer underflow */
    EVSYS_CHANNEL9_TCA0_CMP0_LCMP0_gc = (EVSYS_CHANNEL9_TCA0_CMP0_LCMP0_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A0 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL9_TCA0_CMP1_LCMP1_gc = (EVSYS_CHANNEL9_TCA0_CMP1_LCMP1_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A0 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL9_TCA0_CMP2_LCMP2_gc = (EVSYS_CHANNEL9_TCA0_CMP2_LCMP2_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A0 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL9_TCA1_OVF_LUNF_gc = (EVSYS_CHANNEL9_TCA1_OVF_LUNF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A1 overflow / low byte timer underflow */
    EVSYS_CHANNEL9_TCA1_HUNF_gc    = (EVSYS_CHANNEL9_TCA1_HUNF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A1 high byte timer underflow */
    EVSYS_CHANNEL9_TCA1_CMP0_LCMP0_gc = (EVSYS_CHANNEL9_TCA1_CMP0_LCMP0_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A1 compare 0 / low byte timer compare 0 */
    EVSYS_CHANNEL9_TCA1_CMP1_LCMP1_gc = (EVSYS_CHANNEL9_TCA1_CMP1_LCMP1_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A1 compare 1 / low byte timer compare 1 */
    EVSYS_CHANNEL9_TCA1_CMP2_LCMP2_gc = (EVSYS_CHANNEL9_TCA1_CMP2_LCMP2_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter A1 compare 2 / low byte timer compare 2 */
    EVSYS_CHANNEL9_TCB0_CAPT_gc    = (EVSYS_CHANNEL9_TCB0_CAPT_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B0 capture */
    EVSYS_CHANNEL9_TCB0_OVF_gc     = (EVSYS_CHANNEL9_TCB0_OVF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B0 overflow */
    EVSYS_CHANNEL9_TCB1_CAPT_gc    = (EVSYS_CHANNEL9_TCB1_CAPT_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B1 capture */
    EVSYS_CHANNEL9_TCB1_OVF_gc     = (EVSYS_CHANNEL9_TCB1_OVF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B1 overflow */
    EVSYS_CHANNEL9_TCB2_CAPT_gc    = (EVSYS_CHANNEL9_TCB2_CAPT_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B2 capture */
    EVSYS_CHANNEL9_TCB2_OVF_gc     = (EVSYS_CHANNEL9_TCB2_OVF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B2 overflow */
    EVSYS_CHANNEL9_TCB3_CAPT_gc    = (EVSYS_CHANNEL9_TCB3_CAPT_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B3 capture */
    EVSYS_CHANNEL9_TCB3_OVF_gc     = (EVSYS_CHANNEL9_TCB3_OVF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B3 overflow */
    EVSYS_CHANNEL9_TCB4_CAPT_gc    = (EVSYS_CHANNEL9_TCB4_CAPT_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B4 capture */
    EVSYS_CHANNEL9_TCB4_OVF_gc     = (EVSYS_CHANNEL9_TCB4_OVF_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter B4 overflow */
    EVSYS_CHANNEL9_TCD0_CMPBCLR_gc = (EVSYS_CHANNEL9_TCD0_CMPBCLR_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter D0 event 0 */
    EVSYS_CHANNEL9_TCD0_CMPASET_gc = (EVSYS_CHANNEL9_TCD0_CMPASET_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter D0 event 1 */
    EVSYS_CHANNEL9_TCD0_CMPBSET_gc = (EVSYS_CHANNEL9_TCD0_CMPBSET_gv << EVSYS_CHANNEL9_gp),  /* Timer/Counter D0 event 2 */
    EVSYS_CHANNEL9_TCD0_PROGEV_gc  = (EVSYS_CHANNEL9_TCD0_PROGEV_gv << EVSYS_CHANNEL9_gp)   /* Timer/Counter D0 event 3 */
} EVSYS_CHANNEL9_t;
...
{
    EVSYS_SWEVENTB_CH8_gv          = 0x01,  /* Software event on channel 8 */
    EVSYS_SWEVENTB_CH9_gv          = 0x02   /* Software event on channel 9 */
...
typedef enum EVSYS_USER_VALUES_enum
{
    ...
    EVSYS_USER_CHANNEL6_gv         = 0x07,  /* Connect user to event channel 6 */
    EVSYS_USER_CHANNEL7_gv         = 0x08,  /* Connect user to event channel 7 */
    EVSYS_USER_CHANNEL8_gv         = 0x09,  /* Connect user to event channel 8 */
    EVSYS_USER_CHANNEL9_gv         = 0x0A   /* Connect user to event channel 9 */
} EVSYS_USER_values_t;
...
typedef enum EVSYS_USER_enum
{
    ...
    EVSYS_USER_CHANNEL6_gc         = (EVSYS_USER_CHANNEL6_gv << EVSYS_USER_gp),  /* Connect user to event channel 6 */
    EVSYS_USER_CHANNEL7_gc         = (EVSYS_USER_CHANNEL7_gv << EVSYS_USER_gp),  /* Connect user to event channel 7 */
    EVSYS_USER_CHANNEL8_gc         = (EVSYS_USER_CHANNEL8_gv << EVSYS_USER_gp),  /* Connect user to event channel 8 */
    EVSYS_USER_CHANNEL9_gc         = (EVSYS_USER_CHANNEL9_gv << EVSYS_USER_gp)   /* Connect user to event channel 9 */
} EVSYS_USER_t;
...
/* Output Mode select bit group values */
typedef enum OPAMP_OP0CTRLA_OUTMODE_VALUES_enum
{
    OPAMP_OP0CTRLA_OUTMODE_OFF_gv  = 0x00,  /* Output Driver Off */
    OPAMP_OP0CTRLA_OUTMODE_NORMAL_gv = 0x01   /* Output Driver in Normal Mode */
} OPAMP_OP0CTRLA_OUTMODE_values_t;

/* Output Mode select bit group configurations*/
typedef enum OPAMP_OP0CTRLA_OUTMODE_enum
{
    OPAMP_OP0CTRLA_OUTMODE_OFF_gc  = (OPAMP_OP0CTRLA_OUTMODE_OFF_gv << OPAMP_OUTMODE_gp),  /* Output Driver Off */
    OPAMP_OP0CTRLA_OUTMODE_NORMAL_gc = (OPAMP_OP0CTRLA_OUTMODE_NORMAL_gv << OPAMP_OUTMODE_gp)   /* Output Driver in Normal Mode */
} OPAMP_OP0CTRLA_OUTMODE_t;

/* Negative Input Multiplexer select bit group values */
typedef enum OPAMP_OP0INMUX_MUXNEG_VALUES_enum
{
    OPAMP_OP0INMUX_MUXNEG_INN_gv   = 0x00,  /* Negative input pin for OPn */
    OPAMP_OP0INMUX_MUXNEG_WIP_gv   = 0x01,  /* Wiper from OPn's resistor ladder */
    OPAMP_OP0INMUX_MUXNEG_OUT_gv   = 0x02,  /* OPn output (unity gain) */
    OPAMP_OP0INMUX_MUXNEG_DAC_gv   = 0x03   /* DAC output */
} OPAMP_OP0INMUX_MUXNEG_values_t;

/* Negative Input Multiplexer select bit group configurations*/
typedef enum OPAMP_OP0INMUX_MUXNEG_enum
{
    OPAMP_OP0INMUX_MUXNEG_INN_gc   = (OPAMP_OP0INMUX_MUXNEG_INN_gv << OPAMP_MUXNEG_gp),  /* Negative input pin for OPn */
    OPAMP_OP0INMUX_MUXNEG_WIP_gc   = (OPAMP_OP0INMUX_MUXNEG_WIP_gv << OPAMP_MUXNEG_gp),  /* Wiper from OPn's resistor ladder */
    OPAMP_OP0INMUX_MUXNEG_OUT_gc   = (OPAMP_OP0INMUX_MUXNEG_OUT_gv << OPAMP_MUXNEG_gp),  /* OPn output (unity gain) */
    OPAMP_OP0INMUX_MUXNEG_DAC_gc   = (OPAMP_OP0INMUX_MUXNEG_DAC_gv << OPAMP_MUXNEG_gp)   /* DAC output */
} OPAMP_OP0INMUX_MUXNEG_t;

/* Positive Input Multiplexer select bit group values */
typedef enum OPAMP_OP0INMUX_MUXPOS_VALUES_enum
{
    OPAMP_OP0INMUX_MUXPOS_INP_gv   = 0x00,  /* Positive input pin for OPn */
    OPAMP_OP0INMUX_MUXPOS_WIP_gv   = 0x01,  /* Wiper from OPn's resistor ladder */
    OPAMP_OP0INMUX_MUXPOS_DAC_gv   = 0x02,  /* DAC output */
    OPAMP_OP0INMUX_MUXPOS_GND_gv   = 0x03,  /* Ground */
    OPAMP_OP0INMUX_MUXPOS_VDDDIV2_gv = 0x04   /* VDD/2 */
} OPAMP_OP0INMUX_MUXPOS_values_t;

/* Positive Input Multiplexer select bit group configurations*/
typedef enum OPAMP_OP0INMUX_MUXPOS_enum
{
    OPAMP_OP0INMUX_MUXPOS_INP_gc   = (OPAMP_OP0INMUX_MUXPOS_INP_gv << OPAMP_MUXPOS_gp),  /* Positive input pin for OPn */
    OPAMP_OP0INMUX_MUXPOS_WIP_gc   = (OPAMP_OP0INMUX_MUXPOS_WIP_gv << OPAMP_MUXPOS_gp),  /* Wiper from OPn's resistor ladder */
    OPAMP_OP0INMUX_MUXPOS_DAC_gc   = (OPAMP_OP0INMUX_MUXPOS_DAC_gv << OPAMP_MUXPOS_gp),  /* DAC output */
    OPAMP_OP0INMUX_MUXPOS_GND_gc   = (OPAMP_OP0INMUX_MUXPOS_GND_gv << OPAMP_MUXPOS_gp),  /* Ground */
    OPAMP_OP0INMUX_MUXPOS_VDDDIV2_gc = (OPAMP_OP0INMUX_MUXPOS_VDDDIV2_gv << OPAMP_MUXPOS_gp)   /* VDD/2 */
} OPAMP_OP0INMUX_MUXPOS_t;

/* Multiplexer Bottom select bit group values */
typedef enum OPAMP_OP0RESMUX_MUXBOT_VALUES_enum
{
    OPAMP_OP0RESMUX_MUXBOT_OFF_gv  = 0x00,  /* Multiplexer off */
    OPAMP_OP0RESMUX_MUXBOT_INP_gv  = 0x01,  /* Positive input pin for OPn */
    OPAMP_OP0RESMUX_MUXBOT_INN_gv  = 0x02,  /* Negative input pin for OPn */
    OPAMP_OP0RESMUX_MUXBOT_DAC_gv  = 0x03,  /* DAC output */
    OPAMP_OP0RESMUX_MUXBOT_LINKOUT_gv = 0x04,  /* Link OP[n-1] output */
    OPAMP_OP0RESMUX_MUXBOT_GND_gv  = 0x05   /* Ground */
} OPAMP_OP0RESMUX_MUXBOT_values_t;

/* Multiplexer Bottom select bit group configurations*/
typedef enum OPAMP_OP0RESMUX_MUXBOT_enum
{
    OPAMP_OP0RESMUX_MUXBOT_OFF_gc  = (OPAMP_OP0RESMUX_MUXBOT_OFF_gv << OPAMP_MUXBOT_gp),  /* Multiplexer off */
    OPAMP_OP0RESMUX_MUXBOT_INP_gc  = (OPAMP_OP0RESMUX_MUXBOT_INP_gv << OPAMP_MUXBOT_gp),  /* Positive input pin for OPn */
    OPAMP_OP0RESMUX_MUXBOT_INN_gc  = (OPAMP_OP0RESMUX_MUXBOT_INN_gv << OPAMP_MUXBOT_gp),  /* Negative input pin for OPn */
    OPAMP_OP0RESMUX_MUXBOT_DAC_gc  = (OPAMP_OP0RESMUX_MUXBOT_DAC_gv << OPAMP_MUXBOT_gp),  /* DAC output */
    OPAMP_OP0RESMUX_MUXBOT_LINKOUT_gc = (OPAMP_OP0RESMUX_MUXBOT_LINKOUT_gv << OPAMP_MUXBOT_gp),  /* Link OP[n-1] output */
    OPAMP_OP0RESMUX_MUXBOT_GND_gc  = (OPAMP_OP0RESMUX_MUXBOT_GND_gv << OPAMP_MUXBOT_gp)   /* Ground */
} OPAMP_OP0RESMUX_MUXBOT_t;

/* Multiplexer Top select bit group values */
typedef enum OPAMP_OP0RESMUX_MUXTOP_VALUES_enum
{
    OPAMP_OP0RESMUX_MUXTOP_OFF_gv  = 0x00,  /* Multiplexer off */
    OPAMP_OP0RESMUX_MUXTOP_OUT_gv  = 0x01,  /* OPn output */
    OPAMP_OP0RESMUX_MUXTOP_VDD_gv  = 0x02   /* VDD */
} OPAMP_OP0RESMUX_MUXTOP_values_t;

/* Multiplexer Top select bit group configurations*/
typedef enum OPAMP_OP0RESMUX_MUXTOP_enum
{
    OPAMP_OP0RESMUX_MUXTOP_OFF_gc  = (OPAMP_OP0RESMUX_MUXTOP_OFF_gv << OPAMP_MUXTOP_gp),  /* Multiplexer off */
    OPAMP_OP0RESMUX_MUXTOP_OUT_gc  = (OPAMP_OP0RESMUX_MUXTOP_OUT_gv << OPAMP_MUXTOP_gp),  /* OPn output */
    OPAMP_OP0RESMUX_MUXTOP_VDD_gc  = (OPAMP_OP0RESMUX_MUXTOP_VDD_gv << OPAMP_MUXTOP_gp)   /* VDD */
} OPAMP_OP0RESMUX_MUXTOP_t;

/* Multiplexer Wiper selector bit group values */
typedef enum OPAMP_OP0RESMUX_MUXWIP_VALUES_enum
{
    OPAMP_OP0RESMUX_MUXWIP_WIP0_gv = 0x00,  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
    OPAMP_OP0RESMUX_MUXWIP_WIP1_gv = 0x01,  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
    OPAMP_OP0RESMUX_MUXWIP_WIP2_gv = 0x02,  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
    OPAMP_OP0RESMUX_MUXWIP_WIP3_gv = 0x03,  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
    OPAMP_OP0RESMUX_MUXWIP_WIP4_gv = 0x04,  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
    OPAMP_OP0RESMUX_MUXWIP_WIP5_gv = 0x05,  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
    OPAMP_OP0RESMUX_MUXWIP_WIP6_gv = 0x06,  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
    OPAMP_OP0RESMUX_MUXWIP_WIP7_gv = 0x07   /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
} OPAMP_OP0RESMUX_MUXWIP_values_t;

/* Multiplexer Wiper selector bit group configurations*/
typedef enum OPAMP_OP0RESMUX_MUXWIP_enum
{
    OPAMP_OP0RESMUX_MUXWIP_WIP0_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP0_gv << OPAMP_MUXWIP_gp),  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
    OPAMP_OP0RESMUX_MUXWIP_WIP1_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP1_gv << OPAMP_MUXWIP_gp),  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
    OPAMP_OP0RESMUX_MUXWIP_WIP2_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP2_gv << OPAMP_MUXWIP_gp),  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
    OPAMP_OP0RESMUX_MUXWIP_WIP3_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP3_gv << OPAMP_MUXWIP_gp),  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
    OPAMP_OP0RESMUX_MUXWIP_WIP4_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP4_gv << OPAMP_MUXWIP_gp),  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
    OPAMP_OP0RESMUX_MUXWIP_WIP5_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP5_gv << OPAMP_MUXWIP_gp),  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
    OPAMP_OP0RESMUX_MUXWIP_WIP6_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP6_gv << OPAMP_MUXWIP_gp),  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
    OPAMP_OP0RESMUX_MUXWIP_WIP7_gc = (OPAMP_OP0RESMUX_MUXWIP_WIP7_gv << OPAMP_MUXWIP_gp)   /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
} OPAMP_OP0RESMUX_MUXWIP_t;

/* Output Mode select bit group values */
typedef enum OPAMP_OP1CTRLA_OUTMODE_VALUES_enum
{
    OPAMP_OP1CTRLA_OUTMODE_OFF_gv  = 0x00,  /* Output Driver Off */
    OPAMP_OP1CTRLA_OUTMODE_NORMAL_gv = 0x01   /* Output Driver in Normal Mode */
} OPAMP_OP1CTRLA_OUTMODE_values_t;

/* Output Mode select bit group configurations*/
typedef enum OPAMP_OP1CTRLA_OUTMODE_enum
{
    OPAMP_OP1CTRLA_OUTMODE_OFF_gc  = (OPAMP_OP1CTRLA_OUTMODE_OFF_gv << OPAMP_OUTMODE_gp),  /* Output Driver Off */
    OPAMP_OP1CTRLA_OUTMODE_NORMAL_gc = (OPAMP_OP1CTRLA_OUTMODE_NORMAL_gv << OPAMP_OUTMODE_gp)   /* Output Driver in Normal Mode */
} OPAMP_OP1CTRLA_OUTMODE_t;

/* Negative Input Multiplexer select bit group values */
typedef enum OPAMP_OP1INMUX_MUXNEG_VALUES_enum
{
    OPAMP_OP1INMUX_MUXNEG_INN_gv   = 0x00,  /* Negative input pin for OPn */
    OPAMP_OP1INMUX_MUXNEG_WIP_gv   = 0x01,  /* Wiper from OPn's resistor ladder */
    OPAMP_OP1INMUX_MUXNEG_OUT_gv   = 0x02,  /* OPn output (unity gain) */
    OPAMP_OP1INMUX_MUXNEG_DAC_gv   = 0x03   /* DAC output */
} OPAMP_OP1INMUX_MUXNEG_values_t;

/* Negative Input Multiplexer select bit group configurations*/
typedef enum OPAMP_OP1INMUX_MUXNEG_enum
{
    OPAMP_OP1INMUX_MUXNEG_INN_gc   = (OPAMP_OP1INMUX_MUXNEG_INN_gv << OPAMP_MUXNEG_gp),  /* Negative input pin for OPn */
    OPAMP_OP1INMUX_MUXNEG_WIP_gc   = (OPAMP_OP1INMUX_MUXNEG_WIP_gv << OPAMP_MUXNEG_gp),  /* Wiper from OPn's resistor ladder */
    OPAMP_OP1INMUX_MUXNEG_OUT_gc   = (OPAMP_OP1INMUX_MUXNEG_OUT_gv << OPAMP_MUXNEG_gp),  /* OPn output (unity gain) */
    OPAMP_OP1INMUX_MUXNEG_DAC_gc   = (OPAMP_OP1INMUX_MUXNEG_DAC_gv << OPAMP_MUXNEG_gp)   /* DAC output */
} OPAMP_OP1INMUX_MUXNEG_t;

/* Positive Input Multiplexer select bit group values */
typedef enum OPAMP_OP1INMUX_MUXPOS_VALUES_enum
{
    OPAMP_OP1INMUX_MUXPOS_INP_gv   = 0x00,  /* Positive input pin for OPn */
    OPAMP_OP1INMUX_MUXPOS_WIP_gv   = 0x01,  /* Wiper from OPn's resistor ladder */
    OPAMP_OP1INMUX_MUXPOS_DAC_gv   = 0x02,  /* DAC output */
    OPAMP_OP1INMUX_MUXPOS_GND_gv   = 0x03,  /* Ground */
    OPAMP_OP1INMUX_MUXPOS_VDDDIV2_gv = 0x04,  /* VDD/2 */
    OPAMP_OP1INMUX_MUXPOS_LINKOUT_gv = 0x05   /* Output from OP0 */
} OPAMP_OP1INMUX_MUXPOS_values_t;

/* Positive Input Multiplexer select bit group configurations*/
typedef enum OPAMP_OP1INMUX_MUXPOS_enum
{
    OPAMP_OP1INMUX_MUXPOS_INP_gc   = (OPAMP_OP1INMUX_MUXPOS_INP_gv << OPAMP_MUXPOS_gp),  /* Positive input pin for OPn */
    OPAMP_OP1INMUX_MUXPOS_WIP_gc   = (OPAMP_OP1INMUX_MUXPOS_WIP_gv << OPAMP_MUXPOS_gp),  /* Wiper from OPn's resistor ladder */
    OPAMP_OP1INMUX_MUXPOS_DAC_gc   = (OPAMP_OP1INMUX_MUXPOS_DAC_gv << OPAMP_MUXPOS_gp),  /* DAC output */
    OPAMP_OP1INMUX_MUXPOS_GND_gc   = (OPAMP_OP1INMUX_MUXPOS_GND_gv << OPAMP_MUXPOS_gp),  /* Ground */
    OPAMP_OP1INMUX_MUXPOS_VDDDIV2_gc = (OPAMP_OP1INMUX_MUXPOS_VDDDIV2_gv << OPAMP_MUXPOS_gp),  /* VDD/2 */
    OPAMP_OP1INMUX_MUXPOS_LINKOUT_gc = (OPAMP_OP1INMUX_MUXPOS_LINKOUT_gv << OPAMP_MUXPOS_gp)   /* Output from OP0 */
} OPAMP_OP1INMUX_MUXPOS_t;

/* Multiplexer Bottom select bit group values */
typedef enum OPAMP_OP1RESMUX_MUXBOT_VALUES_enum
{
    OPAMP_OP1RESMUX_MUXBOT_OFF_gv  = 0x00,  /* Multiplexer off */
    OPAMP_OP1RESMUX_MUXBOT_INP_gv  = 0x01,  /* Positive input pin for OPn */
    OPAMP_OP1RESMUX_MUXBOT_INN_gv  = 0x02,  /* Negative input pin for OPn */
    OPAMP_OP1RESMUX_MUXBOT_DAC_gv  = 0x03,  /* DAC output */
    OPAMP_OP1RESMUX_MUXBOT_LINKOUT_gv = 0x04,  /* Link OP[n-1] output */
    OPAMP_OP1RESMUX_MUXBOT_GND_gv  = 0x05   /* Ground */
} OPAMP_OP1RESMUX_MUXBOT_values_t;

/* Multiplexer Bottom select bit group configurations*/
typedef enum OPAMP_OP1RESMUX_MUXBOT_enum
{
    OPAMP_OP1RESMUX_MUXBOT_OFF_gc  = (OPAMP_OP1RESMUX_MUXBOT_OFF_gv << OPAMP_MUXBOT_gp),  /* Multiplexer off */
    OPAMP_OP1RESMUX_MUXBOT_INP_gc  = (OPAMP_OP1RESMUX_MUXBOT_INP_gv << OPAMP_MUXBOT_gp),  /* Positive input pin for OPn */
    OPAMP_OP1RESMUX_MUXBOT_INN_gc  = (OPAMP_OP1RESMUX_MUXBOT_INN_gv << OPAMP_MUXBOT_gp),  /* Negative input pin for OPn */
    OPAMP_OP1RESMUX_MUXBOT_DAC_gc  = (OPAMP_OP1RESMUX_MUXBOT_DAC_gv << OPAMP_MUXBOT_gp),  /* DAC output */
    OPAMP_OP1RESMUX_MUXBOT_LINKOUT_gc = (OPAMP_OP1RESMUX_MUXBOT_LINKOUT_gv << OPAMP_MUXBOT_gp),  /* Link OP[n-1] output */
    OPAMP_OP1RESMUX_MUXBOT_GND_gc  = (OPAMP_OP1RESMUX_MUXBOT_GND_gv << OPAMP_MUXBOT_gp)   /* Ground */
} OPAMP_OP1RESMUX_MUXBOT_t;

/* Multiplexer Top select bit group values */
typedef enum OPAMP_OP1RESMUX_MUXTOP_VALUES_enum
{
    OPAMP_OP1RESMUX_MUXTOP_OFF_gv  = 0x00,  /* Multiplexer off */
    OPAMP_OP1RESMUX_MUXTOP_OUT_gv  = 0x01,  /* OPn output */
    OPAMP_OP1RESMUX_MUXTOP_VDD_gv  = 0x02   /* VDD */
} OPAMP_OP1RESMUX_MUXTOP_values_t;

/* Multiplexer Top select bit group configurations*/
typedef enum OPAMP_OP1RESMUX_MUXTOP_enum
{
    OPAMP_OP1RESMUX_MUXTOP_OFF_gc  = (OPAMP_OP1RESMUX_MUXTOP_OFF_gv << OPAMP_MUXTOP_gp),  /* Multiplexer off */
    OPAMP_OP1RESMUX_MUXTOP_OUT_gc  = (OPAMP_OP1RESMUX_MUXTOP_OUT_gv << OPAMP_MUXTOP_gp),  /* OPn output */
    OPAMP_OP1RESMUX_MUXTOP_VDD_gc  = (OPAMP_OP1RESMUX_MUXTOP_VDD_gv << OPAMP_MUXTOP_gp)   /* VDD */
} OPAMP_OP1RESMUX_MUXTOP_t;

/* Multiplexer Wiper selector bit group values */
typedef enum OPAMP_OP1RESMUX_MUXWIP_VALUES_enum
{
    OPAMP_OP1RESMUX_MUXWIP_WIP0_gv = 0x00,  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
    OPAMP_OP1RESMUX_MUXWIP_WIP1_gv = 0x01,  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
    OPAMP_OP1RESMUX_MUXWIP_WIP2_gv = 0x02,  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
    OPAMP_OP1RESMUX_MUXWIP_WIP3_gv = 0x03,  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
    OPAMP_OP1RESMUX_MUXWIP_WIP4_gv = 0x04,  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
    OPAMP_OP1RESMUX_MUXWIP_WIP5_gv = 0x05,  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
    OPAMP_OP1RESMUX_MUXWIP_WIP6_gv = 0x06,  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
    OPAMP_OP1RESMUX_MUXWIP_WIP7_gv = 0x07   /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
} OPAMP_OP1RESMUX_MUXWIP_values_t;

/* Multiplexer Wiper selector bit group configurations*/
typedef enum OPAMP_OP1RESMUX_MUXWIP_enum
{
    OPAMP_OP1RESMUX_MUXWIP_WIP0_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP0_gv << OPAMP_MUXWIP_gp),  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
    OPAMP_OP1RESMUX_MUXWIP_WIP1_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP1_gv << OPAMP_MUXWIP_gp),  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
    OPAMP_OP1RESMUX_MUXWIP_WIP2_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP2_gv << OPAMP_MUXWIP_gp),  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
    OPAMP_OP1RESMUX_MUXWIP_WIP3_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP3_gv << OPAMP_MUXWIP_gp),  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
    OPAMP_OP1RESMUX_MUXWIP_WIP4_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP4_gv << OPAMP_MUXWIP_gp),  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
    OPAMP_OP1RESMUX_MUXWIP_WIP5_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP5_gv << OPAMP_MUXWIP_gp),  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
    OPAMP_OP1RESMUX_MUXWIP_WIP6_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP6_gv << OPAMP_MUXWIP_gp),  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
    OPAMP_OP1RESMUX_MUXWIP_WIP7_gc = (OPAMP_OP1RESMUX_MUXWIP_WIP7_gv << OPAMP_MUXWIP_gp)   /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
} OPAMP_OP1RESMUX_MUXWIP_t;

/* Output Mode select bit group values */
typedef enum OPAMP_OP2CTRLA_OUTMODE_VALUES_enum
{
    OPAMP_OP2CTRLA_OUTMODE_OFF_gv  = 0x00,  /* Output Driver Off */
    OPAMP_OP2CTRLA_OUTMODE_NORMAL_gv = 0x01   /* Output Driver in Normal Mode */
} OPAMP_OP2CTRLA_OUTMODE_values_t;

/* Output Mode select bit group configurations*/
typedef enum OPAMP_OP2CTRLA_OUTMODE_enum
{
    OPAMP_OP2CTRLA_OUTMODE_OFF_gc  = (OPAMP_OP2CTRLA_OUTMODE_OFF_gv << OPAMP_OUTMODE_gp),  /* Output Driver Off */
    OPAMP_OP2CTRLA_OUTMODE_NORMAL_gc = (OPAMP_OP2CTRLA_OUTMODE_NORMAL_gv << OPAMP_OUTMODE_gp)   /* Output Driver in Normal Mode */
} OPAMP_OP2CTRLA_OUTMODE_t;

/* Negative Input Multiplexer select bit group values */
typedef enum OPAMP_OP2INMUX_MUXNEG_VALUES_enum
{
    OPAMP_OP2INMUX_MUXNEG_INN_gv   = 0x00,  /* Negative input pin for OPn */
    OPAMP_OP2INMUX_MUXNEG_WIP_gv   = 0x01,  /* Wiper from OPn's resistor ladder */
    OPAMP_OP2INMUX_MUXNEG_OUT_gv   = 0x02,  /* OPn output (unity gain) */
    OPAMP_OP2INMUX_MUXNEG_DAC_gv   = 0x03   /* DAC output */
} OPAMP_OP2INMUX_MUXNEG_values_t;

/* Negative Input Multiplexer select bit group configurations*/
typedef enum OPAMP_OP2INMUX_MUXNEG_enum
{
    OPAMP_OP2INMUX_MUXNEG_INN_gc   = (OPAMP_OP2INMUX_MUXNEG_INN_gv << OPAMP_MUXNEG_gp),  /* Negative input pin for OPn */
    OPAMP_OP2INMUX_MUXNEG_WIP_gc   = (OPAMP_OP2INMUX_MUXNEG_WIP_gv << OPAMP_MUXNEG_gp),  /* Wiper from OPn's resistor ladder */
    OPAMP_OP2INMUX_MUXNEG_OUT_gc   = (OPAMP_OP2INMUX_MUXNEG_OUT_gv << OPAMP_MUXNEG_gp),  /* OPn output (unity gain) */
    OPAMP_OP2INMUX_MUXNEG_DAC_gc   = (OPAMP_OP2INMUX_MUXNEG_DAC_gv << OPAMP_MUXNEG_gp)   /* DAC output */
} OPAMP_OP2INMUX_MUXNEG_t;

/* Positive Input Multiplexer select bit group values */
typedef enum OPAMP_OP2INMUX_MUXPOS_VALUES_enum
{
    OPAMP_OP2INMUX_MUXPOS_INP_gv   = 0x00,  /* Positive input pin for OPn */
    OPAMP_OP2INMUX_MUXPOS_WIP_gv   = 0x01,  /* Wiper from OPn's resistor ladder */
    OPAMP_OP2INMUX_MUXPOS_DAC_gv   = 0x02,  /* DAC output */
    OPAMP_OP2INMUX_MUXPOS_GND_gv   = 0x03,  /* Ground */
    OPAMP_OP2INMUX_MUXPOS_VDDDIV2_gv = 0x04,  /* VDD/2 */
    OPAMP_OP2INMUX_MUXPOS_LINKOUT_gv = 0x05,  /* Output from OP1 */
    OPAMP_OP2INMUX_MUXPOS_LINKWIP_gv = 0x06   /* Wiper from OP0's resistor ladder */
} OPAMP_OP2INMUX_MUXPOS_values_t;

/* Positive Input Multiplexer select bit group configurations*/
typedef enum OPAMP_OP2INMUX_MUXPOS_enum
{
    OPAMP_OP2INMUX_MUXPOS_INP_gc   = (OPAMP_OP2INMUX_MUXPOS_INP_gv << OPAMP_MUXPOS_gp),  /* Positive input pin for OPn */
    OPAMP_OP2INMUX_MUXPOS_WIP_gc   = (OPAMP_OP2INMUX_MUXPOS_WIP_gv << OPAMP_MUXPOS_gp),  /* Wiper from OPn's resistor ladder */
    OPAMP_OP2INMUX_MUXPOS_DAC_gc   = (OPAMP_OP2INMUX_MUXPOS_DAC_gv << OPAMP_MUXPOS_gp),  /* DAC output */
    OPAMP_OP2INMUX_MUXPOS_GND_gc   = (OPAMP_OP2INMUX_MUXPOS_GND_gv << OPAMP_MUXPOS_gp),  /* Ground */
    OPAMP_OP2INMUX_MUXPOS_VDDDIV2_gc = (OPAMP_OP2INMUX_MUXPOS_VDDDIV2_gv << OPAMP_MUXPOS_gp),  /* VDD/2 */
    OPAMP_OP2INMUX_MUXPOS_LINKOUT_gc = (OPAMP_OP2INMUX_MUXPOS_LINKOUT_gv << OPAMP_MUXPOS_gp),  /* Output from OP1 */
    OPAMP_OP2INMUX_MUXPOS_LINKWIP_gc = (OPAMP_OP2INMUX_MUXPOS_LINKWIP_gv << OPAMP_MUXPOS_gp)   /* Wiper from OP0's resistor ladder */
} OPAMP_OP2INMUX_MUXPOS_t;

/* Multiplexer Bottom select bit group values */
typedef enum OPAMP_OP2RESMUX_MUXBOT_VALUES_enum
{
    OPAMP_OP2RESMUX_MUXBOT_OFF_gv  = 0x00,  /* Multiplexer off */
    OPAMP_OP2RESMUX_MUXBOT_INP_gv  = 0x01,  /* Positive input pin for OPn */
    OPAMP_OP2RESMUX_MUXBOT_INN_gv  = 0x02,  /* Negative input pin for OPn */
    OPAMP_OP2RESMUX_MUXBOT_DAC_gv  = 0x03,  /* DAC output */
    OPAMP_OP2RESMUX_MUXBOT_LINKOUT_gv = 0x04,  /* Link OP[n-1] output */
    OPAMP_OP2RESMUX_MUXBOT_GND_gv  = 0x05   /* Ground */
} OPAMP_OP2RESMUX_MUXBOT_values_t;

/* Multiplexer Bottom select bit group configurations*/
typedef enum OPAMP_OP2RESMUX_MUXBOT_enum
{
    OPAMP_OP2RESMUX_MUXBOT_OFF_gc  = (OPAMP_OP2RESMUX_MUXBOT_OFF_gv << OPAMP_MUXBOT_gp),  /* Multiplexer off */
    OPAMP_OP2RESMUX_MUXBOT_INP_gc  = (OPAMP_OP2RESMUX_MUXBOT_INP_gv << OPAMP_MUXBOT_gp),  /* Positive input pin for OPn */
    OPAMP_OP2RESMUX_MUXBOT_INN_gc  = (OPAMP_OP2RESMUX_MUXBOT_INN_gv << OPAMP_MUXBOT_gp),  /* Negative input pin for OPn */
    OPAMP_OP2RESMUX_MUXBOT_DAC_gc  = (OPAMP_OP2RESMUX_MUXBOT_DAC_gv << OPAMP_MUXBOT_gp),  /* DAC output */
    OPAMP_OP2RESMUX_MUXBOT_LINKOUT_gc = (OPAMP_OP2RESMUX_MUXBOT_LINKOUT_gv << OPAMP_MUXBOT_gp),  /* Link OP[n-1] output */
    OPAMP_OP2RESMUX_MUXBOT_GND_gc  = (OPAMP_OP2RESMUX_MUXBOT_GND_gv << OPAMP_MUXBOT_gp)   /* Ground */
} OPAMP_OP2RESMUX_MUXBOT_t;

/* Multiplexer Top select bit group values */
typedef enum OPAMP_OP2RESMUX_MUXTOP_VALUES_enum
{
    OPAMP_OP2RESMUX_MUXTOP_OFF_gv  = 0x00,  /* Multiplexer off */
    OPAMP_OP2RESMUX_MUXTOP_OUT_gv  = 0x01,  /* OPn output */
    OPAMP_OP2RESMUX_MUXTOP_VDD_gv  = 0x02   /* VDD */
} OPAMP_OP2RESMUX_MUXTOP_values_t;

/* Multiplexer Top select bit group configurations*/
typedef enum OPAMP_OP2RESMUX_MUXTOP_enum
{
    OPAMP_OP2RESMUX_MUXTOP_OFF_gc  = (OPAMP_OP2RESMUX_MUXTOP_OFF_gv << OPAMP_MUXTOP_gp),  /* Multiplexer off */
    OPAMP_OP2RESMUX_MUXTOP_OUT_gc  = (OPAMP_OP2RESMUX_MUXTOP_OUT_gv << OPAMP_MUXTOP_gp),  /* OPn output */
    OPAMP_OP2RESMUX_MUXTOP_VDD_gc  = (OPAMP_OP2RESMUX_MUXTOP_VDD_gv << OPAMP_MUXTOP_gp)   /* VDD */
} OPAMP_OP2RESMUX_MUXTOP_t;

/* Multiplexer Wiper selector bit group values */
typedef enum OPAMP_OP2RESMUX_MUXWIP_VALUES_enum
{
    OPAMP_OP2RESMUX_MUXWIP_WIP0_gv = 0x00,  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
    OPAMP_OP2RESMUX_MUXWIP_WIP1_gv = 0x01,  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
    OPAMP_OP2RESMUX_MUXWIP_WIP2_gv = 0x02,  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
    OPAMP_OP2RESMUX_MUXWIP_WIP3_gv = 0x03,  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
    OPAMP_OP2RESMUX_MUXWIP_WIP4_gv = 0x04,  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
    OPAMP_OP2RESMUX_MUXWIP_WIP5_gv = 0x05,  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
    OPAMP_OP2RESMUX_MUXWIP_WIP6_gv = 0x06,  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
    OPAMP_OP2RESMUX_MUXWIP_WIP7_gv = 0x07   /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
} OPAMP_OP2RESMUX_MUXWIP_values_t;

/* Multiplexer Wiper selector bit group configurations*/
typedef enum OPAMP_OP2RESMUX_MUXWIP_enum
{
    OPAMP_OP2RESMUX_MUXWIP_WIP0_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP0_gv << OPAMP_MUXWIP_gp),  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
    OPAMP_OP2RESMUX_MUXWIP_WIP1_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP1_gv << OPAMP_MUXWIP_gp),  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
    OPAMP_OP2RESMUX_MUXWIP_WIP2_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP2_gv << OPAMP_MUXWIP_gp),  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
    OPAMP_OP2RESMUX_MUXWIP_WIP3_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP3_gv << OPAMP_MUXWIP_gp),  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
    OPAMP_OP2RESMUX_MUXWIP_WIP4_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP4_gv << OPAMP_MUXWIP_gp),  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
    OPAMP_OP2RESMUX_MUXWIP_WIP5_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP5_gv << OPAMP_MUXWIP_gp),  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
    OPAMP_OP2RESMUX_MUXWIP_WIP6_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP6_gv << OPAMP_MUXWIP_gp),  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
    OPAMP_OP2RESMUX_MUXWIP_WIP7_gc = (OPAMP_OP2RESMUX_MUXWIP_WIP7_gv << OPAMP_MUXWIP_gp)   /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
} OPAMP_OP2RESMUX_MUXWIP_t;

/* Input Range Select bit group values */
typedef enum OPAMP_PWRCTRL_IRSEL_VALUES_enum
{
    OPAMP_PWRCTRL_IRSEL_FULL_gv    = 0x00,  /* Full Input Range */
    OPAMP_PWRCTRL_IRSEL_REDUCED_gv = 0x01   /* Reduced Input Range */
} OPAMP_PWRCTRL_IRSEL_values_t;

/* Input Range Select bit group configurations*/
typedef enum OPAMP_PWRCTRL_IRSEL_enum
{
    OPAMP_PWRCTRL_IRSEL_FULL_gc    = (OPAMP_PWRCTRL_IRSEL_FULL_gv << OPAMP_IRSEL_bp),  /* Full Input Range */
    OPAMP_PWRCTRL_IRSEL_REDUCED_gc = (OPAMP_PWRCTRL_IRSEL_REDUCED_gv << OPAMP_IRSEL_bp)   /* Reduced Input Range */
...
typedef enum PORTMUX_AC0_VALUES_enum
{
    ...
    PORTMUX_AC0_ALT1_gv            = 0x01   /* OUT: PC6 */
...
typedef enum PORTMUX_AC0_enum
{
    ...
    PORTMUX_AC0_ALT1_gc            = (PORTMUX_AC0_ALT1_gv << PORTMUX_AC0_bp)   /* OUT: PC6 */
} PORTMUX_AC0_t;
...
typedef enum PORTMUX_AC1_VALUES_enum
{
    ...
    PORTMUX_AC1_ALT1_gv            = 0x01   /* OUT: PC6 */
...
typedef enum PORTMUX_AC1_enum
{
    ...
    PORTMUX_AC1_ALT1_gc            = (PORTMUX_AC1_ALT1_gv << PORTMUX_AC1_bp)   /* OUT: PC6 */
} PORTMUX_AC1_t;

/* Analog Comparator 2 Output select bit group values */
typedef enum PORTMUX_AC2_VALUES_enum
{
    PORTMUX_AC2_DEFAULT_gv         = 0x00,  /* OUT: PA7 */
    PORTMUX_AC2_ALT1_gv            = 0x01   /* OUT: PC6 */
} PORTMUX_AC2_values_t;

/* Analog Comparator 2 Output select bit group configurations*/
typedef enum PORTMUX_AC2_enum
{
    PORTMUX_AC2_DEFAULT_gc         = (PORTMUX_AC2_DEFAULT_gv << PORTMUX_AC2_bp),  /* OUT: PA7 */
    PORTMUX_AC2_ALT1_gc            = (PORTMUX_AC2_ALT1_gv << PORTMUX_AC2_bp)   /* OUT: PC6 */
} PORTMUX_AC2_t;
...
{
    PORTMUX_EVOUTB_DEFAULT_gv      = 0x00,  /* EVOUTB: PB2 */
    PORTMUX_EVOUTB_ALT1_gv         = 0x01   /* EVOUTB: PB7 */
} PORTMUX_EVOUTB_values_t;

/* Event Output B select bit group configurations*/
typedef enum PORTMUX_EVOUTB_enum
{
    PORTMUX_EVOUTB_DEFAULT_gc      = (PORTMUX_EVOUTB_DEFAULT_gv << PORTMUX_EVOUTB_bp),  /* EVOUTB: PB2 */
    PORTMUX_EVOUTB_ALT1_gc         = (PORTMUX_EVOUTB_ALT1_gv << PORTMUX_EVOUTB_bp)   /* EVOUTB: PB7 */
} PORTMUX_EVOUTB_t;
...
typedef enum PORTMUX_EVOUTC_VALUES_enum
{
    ...
    PORTMUX_EVOUTC_ALT1_gv         = 0x01   /* EVOUTC: PC7 */
...
typedef enum PORTMUX_EVOUTC_enum
{
    ...
    PORTMUX_EVOUTC_ALT1_gc         = (PORTMUX_EVOUTC_ALT1_gv << PORTMUX_EVOUTC_bp)   /* EVOUTC: PC7 */
} PORTMUX_EVOUTC_t;
...
{
    PORTMUX_EVOUTE_DEFAULT_gv      = 0x00,  /* EVOUTE: PE2 */
    PORTMUX_EVOUTE_ALT1_gv         = 0x01   /* EVOUTE: PE7 */
} PORTMUX_EVOUTE_values_t;

/* Event Output E select bit group configurations*/
typedef enum PORTMUX_EVOUTE_enum
{
    PORTMUX_EVOUTE_DEFAULT_gc      = (PORTMUX_EVOUTE_DEFAULT_gv << PORTMUX_EVOUTE_bp),  /* EVOUTE: PE2 */
    PORTMUX_EVOUTE_ALT1_gc         = (PORTMUX_EVOUTE_ALT1_gv << PORTMUX_EVOUTE_bp)   /* EVOUTE: PE7 */
} PORTMUX_EVOUTE_t;
...
/* Event Output G select bit group values */
typedef enum PORTMUX_EVOUTG_VALUES_enum
{
    PORTMUX_EVOUTG_DEFAULT_gv      = 0x00,  /* EVOUTG: PG2 */
    PORTMUX_EVOUTG_ALT1_gv         = 0x01   /* EVOUTG: PG7 */
} PORTMUX_EVOUTG_values_t;

/* Event Output G select bit group configurations*/
typedef enum PORTMUX_EVOUTG_enum
{
    PORTMUX_EVOUTG_DEFAULT_gc      = (PORTMUX_EVOUTG_DEFAULT_gv << PORTMUX_EVOUTG_bp),  /* EVOUTG: PG2 */
    PORTMUX_EVOUTG_ALT1_gc         = (PORTMUX_EVOUTG_ALT1_gv << PORTMUX_EVOUTG_bp)   /* EVOUTG: PG7 */
} PORTMUX_EVOUTG_t;
...
typedef enum PORTMUX_LUT1_VALUES_enum
{
    ...
    PORTMUX_LUT1_ALT1_gv           = 0x01   /* In: PC0, PC1, PC2 Out: PC6 */
...
typedef enum PORTMUX_LUT1_enum
{
    ...
    PORTMUX_LUT1_ALT1_gc           = (PORTMUX_LUT1_ALT1_gv << PORTMUX_LUT1_bp)   /* In: PC0, PC1, PC2 Out: PC6 */
} PORTMUX_LUT1_t;
...
{
    PORTMUX_LUT3_DEFAULT_gv        = 0x00   /* In: PF0, PF1, PF2 Out: PF3 */
} PORTMUX_LUT3_values_t;

/* CCL Look-Up Table 3 Signals select bit group configurations*/
typedef enum PORTMUX_LUT3_enum
{
    PORTMUX_LUT3_DEFAULT_gc        = (PORTMUX_LUT3_DEFAULT_gv << PORTMUX_LUT3_bp)   /* In: PF0, PF1, PF2 Out: PF3 */
} PORTMUX_LUT3_t;

/* CCL Look-Up Table 4 Signals select bit group values */
typedef enum PORTMUX_LUT4_VALUES_enum
{
    PORTMUX_LUT4_DEFAULT_gv        = 0x00,  /* In: PB0, PB1, PB2 Out: PB3 */
    PORTMUX_LUT4_ALT1_gv           = 0x01   /* In: PB0, PB1, PB2 Out: PB6 */
} PORTMUX_LUT4_values_t;

/* CCL Look-Up Table 4 Signals select bit group configurations*/
typedef enum PORTMUX_LUT4_enum
{
    PORTMUX_LUT4_DEFAULT_gc        = (PORTMUX_LUT4_DEFAULT_gv << PORTMUX_LUT4_bp),  /* In: PB0, PB1, PB2 Out: PB3 */
    PORTMUX_LUT4_ALT1_gc           = (PORTMUX_LUT4_ALT1_gv << PORTMUX_LUT4_bp)   /* In: PB0, PB1, PB2 Out: PB6 */
} PORTMUX_LUT4_t;

/* CCL Look-Up Table 5 Signals select bit group values */
typedef enum PORTMUX_LUT5_VALUES_enum
{
    PORTMUX_LUT5_DEFAULT_gv        = 0x00,  /* In: PG0, PG1, PG2 Out: PG3 */
    PORTMUX_LUT5_ALT1_gv           = 0x01   /* In: PG0, PG1, PG2 Out: PG6 */
} PORTMUX_LUT5_values_t;

/* CCL Look-Up Table 5 Signals select bit group configurations*/
typedef enum PORTMUX_LUT5_enum
{
    PORTMUX_LUT5_DEFAULT_gc        = (PORTMUX_LUT5_DEFAULT_gv << PORTMUX_LUT5_bp),  /* In: PG0, PG1, PG2 Out: PG3 */
    PORTMUX_LUT5_ALT1_gc           = (PORTMUX_LUT5_ALT1_gv << PORTMUX_LUT5_bp)   /* In: PG0, PG1, PG2 Out: PG6 */
} PORTMUX_LUT5_t;
...
typedef enum PORTMUX_SPI0_VALUES_enum
{
    ...
    PORTMUX_SPI0_ALT1_gv           = 0x01,  /* MOSI: PE0, MISO: PE1, SCK: PE2, SS: PE3 */
    PORTMUX_SPI0_ALT2_gv           = 0x02,  /* MOSI: PG4, MISO: PG5, SCK: PG6, SS: PG7 */
...
typedef enum PORTMUX_SPI0_enum
{
    ...
    PORTMUX_SPI0_ALT1_gc           = (PORTMUX_SPI0_ALT1_gv << PORTMUX_SPI0_gp),  /* MOSI: PE0, MISO: PE1, SCK: PE2, SS: PE3 */
    PORTMUX_SPI0_ALT2_gc           = (PORTMUX_SPI0_ALT2_gv << PORTMUX_SPI0_gp),  /* MOSI: PG4, MISO: PG5, SCK: PG6, SS: PG7 */
...
{
    PORTMUX_SPI1_DEFAULT_gv        = 0x00,  /* MOSI: PC0, MISO: PC1, SCK: PC2, SS: PC3 */
    PORTMUX_SPI1_ALT1_gv           = 0x01,  /* MOSI: PC4, MISO: PC5, SCK: PC6, SS: PC7 */
    PORTMUX_SPI1_ALT2_gv           = 0x02,  /* MOSI: PB4, MISO: PB5, SCK: PB6, SS: PB7 */
    PORTMUX_SPI1_NONE_gv           = 0x03   /* Not connected to any pins */
} PORTMUX_SPI1_values_t;

/* SPI1 Signals select bit group configurations*/
typedef enum PORTMUX_SPI1_enum
{
    PORTMUX_SPI1_DEFAULT_gc        = (PORTMUX_SPI1_DEFAULT_gv << PORTMUX_SPI1_gp),  /* MOSI: PC0, MISO: PC1, SCK: PC2, SS: PC3 */
    PORTMUX_SPI1_ALT1_gc           = (PORTMUX_SPI1_ALT1_gv << PORTMUX_SPI1_gp),  /* MOSI: PC4, MISO: PC5, SCK: PC6, SS: PC7 */
    PORTMUX_SPI1_ALT2_gc           = (PORTMUX_SPI1_ALT2_gv << PORTMUX_SPI1_gp),  /* MOSI: PB4, MISO: PB5, SCK: PB6, SS: PB7 */
    PORTMUX_SPI1_NONE_gc           = (PORTMUX_SPI1_NONE_gv << PORTMUX_SPI1_gp)   /* Not connected to any pins */
} PORTMUX_SPI1_t;
...
typedef enum PORTMUX_TCA0_VALUES_enum
{
    ...
    PORTMUX_TCA0_PORTB_gv          = 0x01,  /* WOn: PB0, PB1, PB2, PB3, PB4, PB5 */
    PORTMUX_TCA0_PORTC_gv          = 0x02,  /* WOn: PC0, PC1, PC2, PC3, PC4, PC5 */
    PORTMUX_TCA0_PORTD_gv          = 0x03,  /* WOn: PD0, PD1, PD2, PD3, PD4, PD5 */
    PORTMUX_TCA0_PORTE_gv          = 0x04,  /* WOn: PE0, PE1, PE2, PE3, PE4, PE5 */
    PORTMUX_TCA0_PORTF_gv          = 0x05,  /* WOn: PF0, PF1, PF2, PF3, PF4, PF5 */
    PORTMUX_TCA0_PORTG_gv          = 0x06   /* WOn: PG0, PG1, PG2, PG3, PG4, PG5 */
...
typedef enum PORTMUX_TCA0_enum
{
    ...
    PORTMUX_TCA0_PORTB_gc          = (PORTMUX_TCA0_PORTB_gv << PORTMUX_TCA0_gp),  /* WOn: PB0, PB1, PB2, PB3, PB4, PB5 */
    PORTMUX_TCA0_PORTC_gc          = (PORTMUX_TCA0_PORTC_gv << PORTMUX_TCA0_gp),  /* WOn: PC0, PC1, PC2, PC3, PC4, PC5 */
    PORTMUX_TCA0_PORTD_gc          = (PORTMUX_TCA0_PORTD_gv << PORTMUX_TCA0_gp),  /* WOn: PD0, PD1, PD2, PD3, PD4, PD5 */
    PORTMUX_TCA0_PORTE_gc          = (PORTMUX_TCA0_PORTE_gv << PORTMUX_TCA0_gp),  /* WOn: PE0, PE1, PE2, PE3, PE4, PE5 */
    PORTMUX_TCA0_PORTF_gc          = (PORTMUX_TCA0_PORTF_gv << PORTMUX_TCA0_gp),  /* WOn: PF0, PF1, PF2, PF3, PF4, PF5 */
    PORTMUX_TCA0_PORTG_gc          = (PORTMUX_TCA0_PORTG_gv << PORTMUX_TCA0_gp)   /* WOn: PG0, PG1, PG2, PG3, PG4, PG5 */
} PORTMUX_TCA0_t;

/* TCA1 Signals select bit group values */
typedef enum PORTMUX_TCA1_VALUES_enum
{
    PORTMUX_TCA1_PORTB_gv          = 0x00,  /* WOn: PB0, PB1, PB2, PB3, PB4, PB5 */
    PORTMUX_TCA1_PORTC_gv          = 0x01,  /* WOn: PC4, PC5, PC6 */
    PORTMUX_TCA1_PORTE_gv          = 0x02,  /* WOn: PE4, PE5, PE6 */
    PORTMUX_TCA1_PORTG_gv          = 0x03   /* WOn: PG0, PG1, PG2, PG3, PG4, PG5 */
} PORTMUX_TCA1_values_t;

/* TCA1 Signals select bit group configurations*/
typedef enum PORTMUX_TCA1_enum
{
    PORTMUX_TCA1_PORTB_gc          = (PORTMUX_TCA1_PORTB_gv << PORTMUX_TCA1_gp),  /* WOn: PB0, PB1, PB2, PB3, PB4, PB5 */
    PORTMUX_TCA1_PORTC_gc          = (PORTMUX_TCA1_PORTC_gv << PORTMUX_TCA1_gp),  /* WOn: PC4, PC5, PC6 */
    PORTMUX_TCA1_PORTE_gc          = (PORTMUX_TCA1_PORTE_gv << PORTMUX_TCA1_gp),  /* WOn: PE4, PE5, PE6 */
    PORTMUX_TCA1_PORTG_gc          = (PORTMUX_TCA1_PORTG_gv << PORTMUX_TCA1_gp)   /* WOn: PG0, PG1, PG2, PG3, PG4, PG5 */
} PORTMUX_TCA1_t;
...
typedef enum PORTMUX_TCB2_VALUES_enum
{
    ...
    PORTMUX_TCB2_ALT1_gv           = 0x01   /* WO: PB4 */
...
typedef enum PORTMUX_TCB2_enum
{
    ...
    PORTMUX_TCB2_ALT1_gc           = (PORTMUX_TCB2_ALT1_gv << PORTMUX_TCB2_bp)   /* WO: PB4 */
} PORTMUX_TCB2_t;

/* TCB3 Output select bit group values */
typedef enum PORTMUX_TCB3_VALUES_enum
{
    PORTMUX_TCB3_DEFAULT_gv        = 0x00,  /* WO: PB5 */
...
{
    PORTMUX_TCB3_DEFAULT_gc        = (PORTMUX_TCB3_DEFAULT_gv << PORTMUX_TCB3_bp),  /* WO: PB5 */
    PORTMUX_TCB3_ALT1_gc           = (PORTMUX_TCB3_ALT1_gv << PORTMUX_TCB3_bp)   /* WO: PC1 */
} PORTMUX_TCB3_t;

/* TCB4 Output select bit group values */
typedef enum PORTMUX_TCB4_VALUES_enum
{
    PORTMUX_TCB4_DEFAULT_gv        = 0x00   /* WO: PG3 */
} PORTMUX_TCB4_values_t;

/* TCB4 Output select bit group configurations*/
typedef enum PORTMUX_TCB4_enum
{
    PORTMUX_TCB4_DEFAULT_gc        = (PORTMUX_TCB4_DEFAULT_gv << PORTMUX_TCB4_bp)   /* WO: PG3 */
} PORTMUX_TCB4_t;
...
typedef enum PORTMUX_TCD0_VALUES_enum
{
    ...
    PORTMUX_TCD0_ALT1_gv           = 0x01,  /* WOx: PB4, PB5, PB6, PB7 */
    PORTMUX_TCD0_ALT2_gv           = 0x02,  /* WOx: PF0, PF1, PF2, PF3 */
    PORTMUX_TCD0_ALT3_gv           = 0x03   /* WOx: PG4, PG5, PG6, PG7 */
...
typedef enum PORTMUX_TCD0_enum
{
    ...
    PORTMUX_TCD0_ALT1_gc           = (PORTMUX_TCD0_ALT1_gv << PORTMUX_TCD0_gp),  /* WOx: PB4, PB5, PB6, PB7 */
    PORTMUX_TCD0_ALT2_gc           = (PORTMUX_TCD0_ALT2_gv << PORTMUX_TCD0_gp),  /* WOx: PF0, PF1, PF2, PF3 */
    PORTMUX_TCD0_ALT3_gc           = (PORTMUX_TCD0_ALT3_gv << PORTMUX_TCD0_gp)   /* WOx: PG4, PG5, PG6, PG7 */
} PORTMUX_TCD0_t;
...
typedef enum PORTMUX_TWI0_VALUES_enum
{
    ...
    PORTMUX_TWI0_ALT1_gv           = 0x01,  /* SDA: PA2, SCL: PA3. Dual mode: SDA: PC6, SCL: PC7. */
    PORTMUX_TWI0_ALT2_gv           = 0x02   /* SDA: PC2, SCL: PC3. Dual mode: SDA: PC6, SCL: PC7. */
...
typedef enum PORTMUX_TWI0_enum
{
    ...
    PORTMUX_TWI0_ALT1_gc           = (PORTMUX_TWI0_ALT1_gv << PORTMUX_TWI0_gp),  /* SDA: PA2, SCL: PA3. Dual mode: SDA: PC6, SCL: PC7. */
    PORTMUX_TWI0_ALT2_gc           = (PORTMUX_TWI0_ALT2_gv << PORTMUX_TWI0_gp)   /* SDA: PC2, SCL: PC3. Dual mode: SDA: PC6, SCL: PC7. */
} PORTMUX_TWI0_t;

/* TWI1 Signals select bit group values */
typedef enum PORTMUX_TWI1_VALUES_enum
{
    PORTMUX_TWI1_DEFAULT_gv        = 0x00,  /* SDA: PF2, SCL: PF3. Dual mode: SDA: PB2, SCL: PB3. */
    PORTMUX_TWI1_ALT1_gv           = 0x01,  /* SDA: PF2, SCL: PF3. Dual mode: SDA: PB6, SCL: PB7. */
    PORTMUX_TWI1_ALT2_gv           = 0x02   /* SDA: PB2, SCL: PB3. Dual mode: SDA: PB6, SCL: PB7. */
} PORTMUX_TWI1_values_t;

/* TWI1 Signals select bit group configurations*/
typedef enum PORTMUX_TWI1_enum
{
    PORTMUX_TWI1_DEFAULT_gc        = (PORTMUX_TWI1_DEFAULT_gv << PORTMUX_TWI1_gp),  /* SDA: PF2, SCL: PF3. Dual mode: SDA: PB2, SCL: PB3. */
    PORTMUX_TWI1_ALT1_gc           = (PORTMUX_TWI1_ALT1_gv << PORTMUX_TWI1_gp),  /* SDA: PF2, SCL: PF3. Dual mode: SDA: PB6, SCL: PB7. */
    PORTMUX_TWI1_ALT2_gc           = (PORTMUX_TWI1_ALT2_gv << PORTMUX_TWI1_gp)   /* SDA: PB2, SCL: PB3. Dual mode: SDA: PB6, SCL: PB7. */
} PORTMUX_TWI1_t;
...
typedef enum PORTMUX_USART1_VALUES_enum
{
    ...
    PORTMUX_USART1_ALT1_gv         = 0x01,  /* TxD: PC4, RxD: PC5, XCK: PC6, XDIR: PC7 */
...
typedef enum PORTMUX_USART2_enum
{
    ...
    PORTMUX_USART2_ALT1_gc         = (PORTMUX_USART2_ALT1_gv << PORTMUX_USART2_gp),  /* TxD: PF4, RxD: PF5, XDIR: PF3 */
    PORTMUX_USART2_NONE_gc         = (PORTMUX_USART2_NONE_gv << PORTMUX_USART2_gp)   /* Not connected to any pins */
} PORTMUX_USART2_t;

/* USART3  Signals select bit group values */
typedef enum PORTMUX_USART3_VALUES_enum
{
    PORTMUX_USART3_DEFAULT_gv      = 0x00,  /* TxD: PB0, RxD: PB1, XCK: PB2, XDIR: PB3 */
    PORTMUX_USART3_ALT1_gv         = 0x01,  /* TxD: PB4, RxD: PB5, XCK: PB6, XDIR: PB7 */
    PORTMUX_USART3_NONE_gv         = 0x03   /* Not connected to any pins */
} PORTMUX_USART3_values_t;

/* USART3  Signals select bit group configurations*/
typedef enum PORTMUX_USART3_enum
{
    PORTMUX_USART3_DEFAULT_gc      = (PORTMUX_USART3_DEFAULT_gv << PORTMUX_USART3_gp),  /* TxD: PB0, RxD: PB1, XCK: PB2, XDIR: PB3 */
    PORTMUX_USART3_ALT1_gc         = (PORTMUX_USART3_ALT1_gv << PORTMUX_USART3_gp),  /* TxD: PB4, RxD: PB5, XCK: PB6, XDIR: PB7 */
    PORTMUX_USART3_NONE_gc         = (PORTMUX_USART3_NONE_gv << PORTMUX_USART3_gp)   /* Not connected to any pins */
} PORTMUX_USART3_t;

/* USART4 Signals select bit group values */
typedef enum PORTMUX_USART4_VALUES_enum
{
    PORTMUX_USART4_DEFAULT_gv      = 0x00,  /* TxD: PE0, RxD: PE1, XCK: PE2, XDIR: PE3 */
    PORTMUX_USART4_ALT1_gv         = 0x01,  /* TxD: PE4, RxD: PE5, XCK: PE6, XDIR: PE7 */
    PORTMUX_USART4_NONE_gv         = 0x03   /* Not connected to any pins */
} PORTMUX_USART4_values_t;

/* USART4 Signals select bit group configurations*/
typedef enum PORTMUX_USART4_enum
{
    PORTMUX_USART4_DEFAULT_gc      = (PORTMUX_USART4_DEFAULT_gv << PORTMUX_USART4_gp),  /* TxD: PE0, RxD: PE1, XCK: PE2, XDIR: PE3 */
    PORTMUX_USART4_ALT1_gc         = (PORTMUX_USART4_ALT1_gv << PORTMUX_USART4_gp),  /* TxD: PE4, RxD: PE5, XCK: PE6, XDIR: PE7 */
    PORTMUX_USART4_NONE_gc         = (PORTMUX_USART4_NONE_gv << PORTMUX_USART4_gp)   /* Not connected to any pins */
} PORTMUX_USART4_t;

/* USART5 Signals select bit group values */
typedef enum PORTMUX_USART5_VALUES_enum
{
    PORTMUX_USART5_DEFAULT_gv      = 0x00,  /* TxD: PG0, RxD: PG1, XCK: PG2, XDIR: PG3 */
    PORTMUX_USART5_ALT1_gv         = 0x01,  /* TxD: PG4, RxD: PG5, XCK: PG6, XDIR: PG7 */
    PORTMUX_USART5_NONE_gv         = 0x03   /* Not connected to any pins */
} PORTMUX_USART5_values_t;

/* USART5 Signals select bit group configurations*/
typedef enum PORTMUX_USART5_enum
{
    PORTMUX_USART5_DEFAULT_gc      = (PORTMUX_USART5_DEFAULT_gv << PORTMUX_USART5_gp),  /* TxD: PG0, RxD: PG1, XCK: PG2, XDIR: PG3 */
    PORTMUX_USART5_ALT1_gc         = (PORTMUX_USART5_ALT1_gv << PORTMUX_USART5_gp),  /* TxD: PG4, RxD: PG5, XCK: PG6, XDIR: PG7 */
    PORTMUX_USART5_NONE_gc         = (PORTMUX_USART5_NONE_gv << PORTMUX_USART5_gp)   /* Not connected to any pins */
} PORTMUX_USART5_t;

/* Zero Cross Detector 0 Output select bit group values */
typedef enum PORTMUX_ZCD0_VALUES_enum
{
    PORTMUX_ZCD0_DEFAULT_gv        = 0x00,  /* OUT: PA7 */
    PORTMUX_ZCD0_ALT1_gv           = 0x01   /* OUT: PC7 */
} PORTMUX_ZCD0_values_t;

/* Zero Cross Detector 0 Output select bit group configurations*/
typedef enum PORTMUX_ZCD0_enum
{
    PORTMUX_ZCD0_DEFAULT_gc        = (PORTMUX_ZCD0_DEFAULT_gv << PORTMUX_ZCD0_bp),  /* OUT: PA7 */
    PORTMUX_ZCD0_ALT1_gc           = (PORTMUX_ZCD0_ALT1_gv << PORTMUX_ZCD0_bp)   /* OUT: PC7 */
} PORTMUX_ZCD0_t;

/* Zero Cross Detector 1 Output select bit group values */
typedef enum PORTMUX_ZCD1_VALUES_enum
{
    PORTMUX_ZCD1_DEFAULT_gv        = 0x00,  /* OUT: PA7 */
    PORTMUX_ZCD1_ALT1_gv           = 0x01   /* OUT: PC7 */
} PORTMUX_ZCD1_values_t;

/* Zero Cross Detector 1 Output select bit group configurations*/
typedef enum PORTMUX_ZCD1_enum
{
    PORTMUX_ZCD1_DEFAULT_gc        = (PORTMUX_ZCD1_DEFAULT_gv << PORTMUX_ZCD1_bp),  /* OUT: PA7 */
    PORTMUX_ZCD1_ALT1_gc           = (PORTMUX_ZCD1_ALT1_gv << PORTMUX_ZCD1_bp)   /* OUT: PC7 */
} PORTMUX_ZCD1_t;

/* Zero Cross Detector 2 Output select bit group values */
typedef enum PORTMUX_ZCD2_VALUES_enum
{
    PORTMUX_ZCD2_DEFAULT_gv        = 0x00,  /* OUT: PA7 */
    PORTMUX_ZCD2_ALT1_gv           = 0x01   /* OUT: PC7 */
} PORTMUX_ZCD2_values_t;

/* Zero Cross Detector 2 Output select bit group configurations*/
typedef enum PORTMUX_ZCD2_enum
{
    PORTMUX_ZCD2_DEFAULT_gc        = (PORTMUX_ZCD2_DEFAULT_gv << PORTMUX_ZCD2_bp),  /* OUT: PA7 */
    PORTMUX_ZCD2_ALT1_gc           = (PORTMUX_ZCD2_ALT1_gv << PORTMUX_ZCD2_bp)   /* OUT: PC7 */
} PORTMUX_ZCD2_t;
...
typedef enum RTC_CLKSEL_VALUES_enum
{
    ...
    RTC_CLKSEL_XOSC32K_gv          = 0x02,  /* 32.768 kHz from XOSC32K */
...
typedef enum RTC_CLKSEL_enum
{
    ...
    RTC_CLKSEL_XOSC32K_gc          = (RTC_CLKSEL_XOSC32K_gv << RTC_CLKSEL_gp),  /* 32.768 kHz from XOSC32K */
...
/* FM Plus Enable select bit group values */
...
/* FM Plus Enable select bit group configurations*/
