...
{
    PORTMUX_LUT1_DEFAULT_gv        = 0x00,  /* INn: -, PC1, PC2 OUT: PC3 */
    PORTMUX_LUT1_ALT1_gv           = 0x01   /* INn: -, PC1, PC2 OUT: - */
} PORTMUX_LUT1_values_t;

/* CCL Look-Up Table 1 Signals select bit group configurations*/
typedef enum PORTMUX_LUT1_enum
{
    PORTMUX_LUT1_DEFAULT_gc        = (PORTMUX_LUT1_DEFAULT_gv << PORTMUX_LUT1_bp),  /* INn: -, PC1, PC2 OUT: PC3 */
    PORTMUX_LUT1_ALT1_gc           = (PORTMUX_LUT1_ALT1_gv << PORTMUX_LUT1_bp)   /* INn: -, PC1, PC2 OUT: - */
} PORTMUX_LUT1_t;
...
typedef enum PORTMUX_SPI0_VALUES_enum
{
    ...
    PORTMUX_SPI0_ALT3_gv           = 0x03,  /* MOSI: PA0, MISO: PA1, SCK: -, SS: PC1 */
    PORTMUX_SPI0_ALT4_gv           = 0x04,  /* MOSI: PD4, MISO: PD5, SCK: PD6, SS: PD7 */
    PORTMUX_SPI0_ALT5_gv           = 0x05,  /* MOSI: -, MISO: PC1, SCK: PC2, SS: PC3 */
...
typedef enum PORTMUX_SPI0_enum
{
    ...
    PORTMUX_SPI0_ALT3_gc           = (PORTMUX_SPI0_ALT3_gv << PORTMUX_SPI0_gp),  /* MOSI: PA0, MISO: PA1, SCK: -, SS: PC1 */
    PORTMUX_SPI0_ALT4_gc           = (PORTMUX_SPI0_ALT4_gv << PORTMUX_SPI0_gp),  /* MOSI: PD4, MISO: PD5, SCK: PD6, SS: PD7 */
    PORTMUX_SPI0_ALT5_gc           = (PORTMUX_SPI0_ALT5_gv << PORTMUX_SPI0_gp),  /* MOSI: -, MISO: PC1, SCK: PC2, SS: PC3 */
...
typedef enum PORTMUX_TCA0_VALUES_enum
{
    ...
    PORTMUX_TCA0_PORTC_gv          = 0x02,  /* WOn: -, PC1, PC2, PC3, -, - */
...
typedef enum PORTMUX_TCA0_enum
{
    ...
    PORTMUX_TCA0_PORTC_gc          = (PORTMUX_TCA0_PORTC_gv << PORTMUX_TCA0_gp),  /* WOn: -, PC1, PC2, PC3, -, - */
...
{
    PORTMUX_TCD0_DEFAULT_gv        = 0x00,  /* Not connected to any pins */
    PORTMUX_TCD0_ALT4_gv           = 0x04   /* WOx: -, -, PD4, PD5 */
} PORTMUX_TCD0_values_t;

/* TCD0 Signals select bit group configurations*/
typedef enum PORTMUX_TCD0_enum
{
    PORTMUX_TCD0_DEFAULT_gc        = (PORTMUX_TCD0_DEFAULT_gv << PORTMUX_TCD0_gp),  /* Not connected to any pins */
    PORTMUX_TCD0_ALT4_gc           = (PORTMUX_TCD0_ALT4_gv << PORTMUX_TCD0_gp)   /* WOx: -, -, PD4, PD5 */
} PORTMUX_TCD0_t;
...
{
    PORTMUX_USART1_DEFAULT_gv      = 0x00,  /* TxD: -, RxD: PC1, XCK: PC2, XDIR: PC3 */
...
{
    PORTMUX_USART1_DEFAULT_gc      = (PORTMUX_USART1_DEFAULT_gv << PORTMUX_USART1_gp),  /* TxD: -, RxD: PC1, XCK: PC2, XDIR: PC3 */
