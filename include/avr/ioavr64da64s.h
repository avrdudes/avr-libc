...
#  define _AVR_IOXXX_H_ "ioavr64da64s.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_AVR64DA64S_H_INCLUDED
#define _AVR_AVR64DA64S_H_INCLUDED
...
typedef enum EVSYS_CHANNEL0_VALUES_enum
{
    ...
    EVSYS_CHANNEL0_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL0_enum
{
    ...
    EVSYS_CHANNEL0_PTC_RESRDY_gc   = (EVSYS_CHANNEL0_PTC_RESRDY_gv << EVSYS_CHANNEL0_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL1_VALUES_enum
{
    ...
    EVSYS_CHANNEL1_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL1_enum
{
    ...
    EVSYS_CHANNEL1_PTC_RESRDY_gc   = (EVSYS_CHANNEL1_PTC_RESRDY_gv << EVSYS_CHANNEL1_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL2_VALUES_enum
{
    ...
    EVSYS_CHANNEL2_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL2_enum
{
    ...
    EVSYS_CHANNEL2_PTC_RESRDY_gc   = (EVSYS_CHANNEL2_PTC_RESRDY_gv << EVSYS_CHANNEL2_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL3_VALUES_enum
{
    ...
    EVSYS_CHANNEL3_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL3_enum
{
    ...
    EVSYS_CHANNEL3_PTC_RESRDY_gc   = (EVSYS_CHANNEL3_PTC_RESRDY_gv << EVSYS_CHANNEL3_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL4_VALUES_enum
{
    ...
    EVSYS_CHANNEL4_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL4_enum
{
    ...
    EVSYS_CHANNEL4_PTC_RESRDY_gc   = (EVSYS_CHANNEL4_PTC_RESRDY_gv << EVSYS_CHANNEL4_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL5_VALUES_enum
{
    ...
    EVSYS_CHANNEL5_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL5_enum
{
    ...
    EVSYS_CHANNEL5_PTC_RESRDY_gc   = (EVSYS_CHANNEL5_PTC_RESRDY_gv << EVSYS_CHANNEL5_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL6_VALUES_enum
{
    ...
    EVSYS_CHANNEL6_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL6_enum
{
    ...
    EVSYS_CHANNEL6_PTC_RESRDY_gc   = (EVSYS_CHANNEL6_PTC_RESRDY_gv << EVSYS_CHANNEL6_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL7_VALUES_enum
{
    ...
    EVSYS_CHANNEL7_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL7_enum
{
    ...
    EVSYS_CHANNEL7_PTC_RESRDY_gc   = (EVSYS_CHANNEL7_PTC_RESRDY_gv << EVSYS_CHANNEL7_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL8_VALUES_enum
{
    ...
    EVSYS_CHANNEL8_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL8_enum
{
    ...
    EVSYS_CHANNEL8_PTC_RESRDY_gc   = (EVSYS_CHANNEL8_PTC_RESRDY_gv << EVSYS_CHANNEL8_gp),  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL9_VALUES_enum
{
    ...
    EVSYS_CHANNEL9_PTC_RESRDY_gv   = 0x28,  /* PTC Result Ready */
...
typedef enum EVSYS_CHANNEL9_enum
{
    ...
    EVSYS_CHANNEL9_PTC_RESRDY_gc   = (EVSYS_CHANNEL9_PTC_RESRDY_gv << EVSYS_CHANNEL9_gp),  /* PTC Result Ready */
...
{
    PORTMUX_EVOUTA_DEFAULT_gv      = 0x00,  /* EVOUT: PA2 */
    PORTMUX_EVOUTA_ALT1_gv         = 0x01   /* EVOUT: PA7 */
} PORTMUX_EVOUTA_values_t;

/* Event Output A select bit group configurations*/
typedef enum PORTMUX_EVOUTA_enum
{
    PORTMUX_EVOUTA_DEFAULT_gc      = (PORTMUX_EVOUTA_DEFAULT_gv << PORTMUX_EVOUTA_bp),  /* EVOUT: PA2 */
    PORTMUX_EVOUTA_ALT1_gc         = (PORTMUX_EVOUTA_ALT1_gv << PORTMUX_EVOUTA_bp)   /* EVOUT: PA7 */
} PORTMUX_EVOUTA_t;

/* Event Output B select bit group values */
typedef enum PORTMUX_EVOUTB_VALUES_enum
{
    PORTMUX_EVOUTB_DEFAULT_gv      = 0x00,  /* EVOUT: PB2 */
    PORTMUX_EVOUTB_ALT1_gv         = 0x01   /* EVOUT: PB7 */
} PORTMUX_EVOUTB_values_t;

/* Event Output B select bit group configurations*/
typedef enum PORTMUX_EVOUTB_enum
{
    PORTMUX_EVOUTB_DEFAULT_gc      = (PORTMUX_EVOUTB_DEFAULT_gv << PORTMUX_EVOUTB_bp),  /* EVOUT: PB2 */
    PORTMUX_EVOUTB_ALT1_gc         = (PORTMUX_EVOUTB_ALT1_gv << PORTMUX_EVOUTB_bp)   /* EVOUT: PB7 */
} PORTMUX_EVOUTB_t;

/* Event Output C select bit group values */
typedef enum PORTMUX_EVOUTC_VALUES_enum
{
    PORTMUX_EVOUTC_DEFAULT_gv      = 0x00,  /* EVOUT: PC2 */
    PORTMUX_EVOUTC_ALT1_gv         = 0x01   /* EVOUT: PC7 */
} PORTMUX_EVOUTC_values_t;

/* Event Output C select bit group configurations*/
typedef enum PORTMUX_EVOUTC_enum
{
    PORTMUX_EVOUTC_DEFAULT_gc      = (PORTMUX_EVOUTC_DEFAULT_gv << PORTMUX_EVOUTC_bp),  /* EVOUT: PC2 */
    PORTMUX_EVOUTC_ALT1_gc         = (PORTMUX_EVOUTC_ALT1_gv << PORTMUX_EVOUTC_bp)   /* EVOUT: PC7 */
} PORTMUX_EVOUTC_t;

/* Event Output D select bit group values */
typedef enum PORTMUX_EVOUTD_VALUES_enum
{
    PORTMUX_EVOUTD_DEFAULT_gv      = 0x00,  /* EVOUT: PD2 */
    PORTMUX_EVOUTD_ALT1_gv         = 0x01   /* EVOUT: PD7 */
} PORTMUX_EVOUTD_values_t;

/* Event Output D select bit group configurations*/
typedef enum PORTMUX_EVOUTD_enum
{
    PORTMUX_EVOUTD_DEFAULT_gc      = (PORTMUX_EVOUTD_DEFAULT_gv << PORTMUX_EVOUTD_bp),  /* EVOUT: PD2 */
    PORTMUX_EVOUTD_ALT1_gc         = (PORTMUX_EVOUTD_ALT1_gv << PORTMUX_EVOUTD_bp)   /* EVOUT: PD7 */
} PORTMUX_EVOUTD_t;

/* Event Output E select bit group values */
typedef enum PORTMUX_EVOUTE_VALUES_enum
{
    PORTMUX_EVOUTE_DEFAULT_gv      = 0x00,  /* EVOUT: PE2 */
    PORTMUX_EVOUTE_ALT1_gv         = 0x01   /* EVOUT: PE7 */
} PORTMUX_EVOUTE_values_t;

/* Event Output E select bit group configurations*/
typedef enum PORTMUX_EVOUTE_enum
{
    PORTMUX_EVOUTE_DEFAULT_gc      = (PORTMUX_EVOUTE_DEFAULT_gv << PORTMUX_EVOUTE_bp),  /* EVOUT: PE2 */
    PORTMUX_EVOUTE_ALT1_gc         = (PORTMUX_EVOUTE_ALT1_gv << PORTMUX_EVOUTE_bp)   /* EVOUT: PE7 */
} PORTMUX_EVOUTE_t;

/* Event Output F select bit group values */
typedef enum PORTMUX_EVOUTF_VALUES_enum
{
    PORTMUX_EVOUTF_DEFAULT_gv      = 0x00   /* EVOUT: PF2 */
} PORTMUX_EVOUTF_values_t;

/* Event Output F select bit group configurations*/
typedef enum PORTMUX_EVOUTF_enum
{
    PORTMUX_EVOUTF_DEFAULT_gc      = (PORTMUX_EVOUTF_DEFAULT_gv << PORTMUX_EVOUTF_bp)   /* EVOUT: PF2 */
} PORTMUX_EVOUTF_t;

/* Event Output G select bit group values */
typedef enum PORTMUX_EVOUTG_VALUES_enum
{
    PORTMUX_EVOUTG_DEFAULT_gv      = 0x00,  /* EVOUT: PG2 */
    PORTMUX_EVOUTG_ALT1_gv         = 0x01   /* EVOUT: PG7 */
} PORTMUX_EVOUTG_values_t;

/* Event Output G select bit group configurations*/
typedef enum PORTMUX_EVOUTG_enum
{
    PORTMUX_EVOUTG_DEFAULT_gc      = (PORTMUX_EVOUTG_DEFAULT_gv << PORTMUX_EVOUTG_bp),  /* EVOUT: PG2 */
    PORTMUX_EVOUTG_ALT1_gc         = (PORTMUX_EVOUTG_ALT1_gv << PORTMUX_EVOUTG_bp)   /* EVOUT: PG7 */
} PORTMUX_EVOUTG_t;
...
typedef enum PORTMUX_TCB4_VALUES_enum
{
    ...
    PORTMUX_TCB4_ALT1_gv           = 0x01   /* WO: PC6 */
...
typedef enum PORTMUX_TCB4_enum
{
    ...
    PORTMUX_TCB4_ALT1_gc           = (PORTMUX_TCB4_ALT1_gv << PORTMUX_TCB4_bp)   /* WO: PC6 */
} PORTMUX_TCB4_t;
...
#endif /* #ifdef _AVR_AVR64DA64S_H_INCLUDED */
