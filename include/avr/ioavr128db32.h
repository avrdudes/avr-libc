...
{
    PORTMUX_LUT2_DEFAULT_gv        = 0x00,  /* In: -, PD1, PD2 Out: PD3 */
    PORTMUX_LUT2_ALT1_gv           = 0x01   /* In: -, PD1, PD2 Out: PD6 */
} PORTMUX_LUT2_values_t;

/* CCL Look-Up Table 2 Signals select bit group configurations*/
typedef enum PORTMUX_LUT2_enum
{
    PORTMUX_LUT2_DEFAULT_gc        = (PORTMUX_LUT2_DEFAULT_gv << PORTMUX_LUT2_bp),  /* In: -, PD1, PD2 Out: PD3 */
    PORTMUX_LUT2_ALT1_gc           = (PORTMUX_LUT2_ALT1_gv << PORTMUX_LUT2_bp)   /* In: -, PD1, PD2 Out: PD6 */
} PORTMUX_LUT2_t;
...
{
    PORTMUX_TWI1_DEFAULT_gv        = 0x00,  /* SDA: PF2, SCL: PF3. Dual mode: SDA: -, SCL: -. */
...
{
    PORTMUX_TWI1_DEFAULT_gc        = (PORTMUX_TWI1_DEFAULT_gv << PORTMUX_TWI1_gp),  /* SDA: PF2, SCL: PF3. Dual mode: SDA: -, SCL: -. */
