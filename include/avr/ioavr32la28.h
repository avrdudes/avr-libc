...
{
    PORTMUX_LUT3_DEFAULT_gv        = 0x00   /* INn: PF0, PF1, -. OUT: -. */
} PORTMUX_LUT3_values_t;

/* CCL Look-Up Table 3 Signals select bit group configurations*/
typedef enum PORTMUX_LUT3_enum
{
    PORTMUX_LUT3_DEFAULT_gc        = (PORTMUX_LUT3_DEFAULT_gv << PORTMUX_LUT3_bp)   /* INn: PF0, PF1, -. OUT: -. */
} PORTMUX_LUT3_t;
...
typedef enum PORTMUX_TCE0_VALUES_enum
{
    ...
    PORTMUX_TCE0_PORTF_gv          = 0x05   /* WOn: PF0, PF1, - */
...
typedef enum PORTMUX_TCE0_enum
{
    ...
    PORTMUX_TCE0_PORTF_gc          = (PORTMUX_TCE0_PORTF_gv << PORTMUX_TCE0_gp)   /* WOn: PF0, PF1, - */
} PORTMUX_TCE0_t;
