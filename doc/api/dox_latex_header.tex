...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% This overrides DoxyCode from doxygen.sty

% Used by @code ... @endcode
\renewenvironment{DoxyCode}[1]{%
  \par%
%%% Added this \vspace to get a litle headroom above @code.
  \vspace{1ex}%
%%%  \scriptsize%
  \footnotesize% ...instead of scriptsize
  \normalfont\ttfamily%
...
%%% This overrides \doxyparagraph from latex_src/doxygen.sty
%%% so that the text in the paragraph starts in a new line
%%% (instead of putting the text right after the paragraph title))).
\makeatletter
